OC.L10N.register(
    ...
    "- 📂 Sort bookmarks into folders\n- 🏷 Add tags and personal notes\n- ☠ Find broken links and duplicates\n- 📲 Synchronize with all your browsers and devices\n- 📔 Store archived versions of your links in case they are depublished\n- 🔍 Full-text search on site contents\n- 👪 Share bookmarks with other users, groups and teams or via public links\n- ⚛ Generate RSS feeds of your collections\n- 📈 Stats on how often you access which links\n- 🔒 Automatic backups of your bookmarks collection\n- 💼 Built-in Dashboard widgets for frequent and recent links\n\nRequirements:\n - PHP extensions:\n   - intl: *\n   - mbstring: *\n - when using MySQL, use at least v8.0" : "- 📂 Vytřídění záložek do složek\n- 🏷 Přidávání štítků a osobní poznámek\n- ☠ Opravení rozbitých odkazů a duplikátů\n- 📲 Synchronizace se všemi vašimi prohlížeči a zařízeními\n- 📔 Ukládání archivovaných verzí vašich odkazů pro případ jejich stažení z internetu\n- 🔍 Fulltextové vyhledávání obsahu stránek\n- 👪 Sdílení záložek s ostatními uživateli, skupinami, týmy nebo přes veřejný odkaz\n- ⚛ Generování RSS kanálů vašich kolekcí\n- 📈 Statistiky vaší návštěvnosti odkazů\n- 🔒 Automatické zálohy vaší kolekce záložek\n- 💼 Integrované ovládací prvky nástěnky pro časné a nedávné odkazy\n\nPožadavky:\n - PHP rozšíření:\n   - intl: *\n   - mbstring: *\n - při používání MySQL, použijte alespoň v8.0",
    ...
    "Loading trashbin" : "Načítání koše",
    "Restoring folder" : "Obnovování složky",
    ...
    "If you have problems with this Bookmarks app or have an idea about what could be improved, don't hesitate to get in touch by clicking here." : "Pokud máte s aplikací Záložky problémy nebo máte nápad ohledně jejího vylepšení, neváhejte nás kontaktovat a to kliknutím sem.",
    "Support this project" : "Podpořte tento projekt",
    "My work on this Bookmarks app is fuelled by a voluntary subscription model. If you think what I do is worthwhile, I would be happy if you could support my work. Also, please consider giving the app a review on the Nextcloud app store. Thank you 💙 " : "Moje práce na této aplikaci Záložky je poháněna modelem dobrovolného předplatného. Pokud si myslíte, že to, co dělám má význam, potěšilo by mne pokud byste mou práci podpořili. Také prosím zvažte ohodnocení aplikace v katalogu aplikací pro Nextcloud. Děkuji 💙",
    "Created {time} ago" : "Vytvořeno před {time}",
    "Created on {date}" : "Vytvořeno {date}",
    "(Empty title)" : "(Prázný nadpis)",
    "Title" : "Nadpis",
    "Link" : "Odkaz",
    ...
    "Would you like to support this project?" : "Chcete tento projekt podpořit?",
    "Leave a rating on the Nextcloud App Store" : "Ohodnotit v katalogu aplikací pro Nextcloud",
    "Failed to save settings" : "Nastavení se nepodařilo uložit",
    "Failed to load settings" : "Nepodařilo se načíst nastavení",
    "Privacy" : "Soukromí",
    "The app will try to access web pages that you add to automatically add information about them." : "Aplikace se pokusí přistoupit k webovým stránkám které přidáte a automaticky tak přidat informace o nich.",
    ...
    "Previews" : "Náhledy",
    "In order to display real screenshots of your bookmarked websites, the app can use third-party services to generate previews." : "Pro zobrazování skutečných snímků obrazovky webů, které máte v záložkách, aplikace může použít pro vytváření náhledů služby třetích stran.",
    "Screeenly" : "Screeenly",
    ...
    "Generic screenshot API" : "Obecné API rozhraní pro snímky obrazovky",
    "Sign up with any of the screenshot API providers and put the API URL below. Use the variable {url} as a placeholder for the URL to screenshot. The API must return only the image directly." : "Vytvořte si účet u libovolného poskytovatele API rozhraní snímků obrazovky a URL API vložte níže. Jako zástupné vyjádření URL, které pořídit snímek obrazovky, použijte proměnnou {url}. Je třeba, aby API přímo vracelo obrázek a nic jiného.",
    "Generic API URL" : "URL obecného API rozhraní pro snímky obrazovky",
    "Pageres CLI" : "Pageres CLI",
    "Simply install the Pageres CLI by Sindre Sorhus on your server and Bookmarks will find it. You can still add additional ENV vars to be fed to pageres, e.g. as indicated in the placeholder:" : "Stačí si na server nainstalovat Pageres CLI od Sindreho Sorhuse a Záložky ho použijí. I tak je možné přidávat další proměnné prostředí, které předat pageres, např. jako naznačeno v zástupném vyjádření:",
    ...
    "Failed to count deleted bookmarks" : "Nepodařilo se spočítat smazané záložky",
    "Failed to count duplicated bookmarks" : "Nepodařilo se spočítat duplicitní záložky",
    "Failed to count bookmarks" : "Nepodařilo se spočítat záložky",
    ...
    "Failed to restore bookmark" : "Nepodařilo se obnovit záložku",
    ...
    "Failed to restore folder" : "Nepodařilo se obnovit složku",
    "Failed to create folder" : "Složku se nepodařilo vytvořit",
    "Failed to load children order" : "Nepodařilo se načíst pořadí podřízeného",
    "Failed to move parts of selection" : "Nepodařilo se přesunout část výběru",
    "Failed to copy parts of selection" : "Nepodařilo se zkopírovat části výběru",
    "Failed to delete parts of selection" : "Část výběru se nepodařilo smazat",
    "Failed to tag parts of selection" : "Nepodařilo se označit štítkem části výběru",
    "Failed to fetch bookmarks." : "Záložky se nepodařilo stáhnout.",
    "Failed to store setting" : "Nastavení se nepodařilo uložit",
    "Failed to load setting {key}" : "Nepodařilo se načíst nastavení {key}",
    "Failed to create share for folder {folderId}" : "Nepodařilo se vytvořit sdílení pro složku {folderId}",
    ...
    "Failed to create public link for folder {folderId}" : "Nepodařilo se vytvořit veřejný odkaz pro složku {folderId}",
    "Failed to delete public link for folder {folderId}" : "Nepodařilo se smazat veřejný odkaz pro složku {folderId}",
    "Failed to permanently delete parts of trash bin" : "Nepodařilo se nevratně smazat části koše",

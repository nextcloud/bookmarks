OC.L10N.register(
    ...
    "- 📂 Browse and filter your bookmarks via tags and folders and add personal notes\n- 🔍 Built-in full-text search integrated into Nextcloud's unified search\n- 👪 Share bookmarks with other users as well as publicly\n- 💡 Keep track of changes in the activity stream\n- ☠ Easily find broken links\n- 📔 All your links are automatically archived for full-text search and in case they are depublished\n- 📲 Access your bookmarks anywhere, on desktop Browsers and on your phone, via a variety of sync clients\n- 💼 Built-in Dashboard widgets for frequent and recent links\n- ⚛ Easily generate public and private RSS feeds of your collections\n\nRequirements:\n - PHP v7.3+\n - PHP extensions:\n   - intl: *\n   - mbstring: *\n - Nextcloud v20+" : "- 📂 Procházejte a filtrujte své záložky prostřednictvím štítků a složek a přidávejte své osobní poznámky\n- 🔍 Vestavěné plnotextové vyhledávání začleněné do sjednoceného vyhledávání v rámci Nextcloud\n- 👪 Nasdílejte záložky ostatním uživatelům nebo veřejnosti\n- 💡 Mějte přehled o změnách díky proudu aktivit\n- ☠ Snadno zjistěte nefunkční odkazy\n- 📔 Všechny vaše odkazy jsou automaticky archivovány pro plnotextové vyhledávání a pro případ, že už obsah není veřejně dostupný\n- 📲 Přistupujte ke svým záložkám odkudkoli, na prohlížečích na počítači nebo telefonu, prostřednictvím různých synchronizačních klientů\n- 💼 Vestavěné prvky přehledu pro často navštěvované a nedávné odkazy\n- ⚛ Snadno vytvářejte veřejné a soukromé RSS kanály svých svých sbírek\n\nPožadavky:\n - PHP v7.3+\n - PHP rozšíření:\n   - intl: *\n   - mbstring: *\n - Nextcloud v20+",
    ...
    "Simply install the Pageres CLI on your server and Bookmarks will find it." : "Stačí jen nainstalovat Pageres CLI na váš server a aplikace Záložky si ho najde.",

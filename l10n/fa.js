OC.L10N.register(
    ...
    "This app provides you with a web interface for collecting and organizing bookmarks to the sites on the web that are precious to you.\nYou can browse and filter your bookmarks via tags and folders and by using the built-in search feature.\nAlso, in order to access your bookmarks anywhere, it also allows you to synchronize with third-party clients via a built-in REST API -- be it in your browsers or on your phone.\nCheck out the third-party clients listed here: https://github.com/nextcloud/bookmarks#third-party-clients\n\nRequirements:\n - PHP v7.1+\n - PHP extensions:\n   - gmp: *\n   - intl: *\n   - mbstring: *" : "این برنامه یک واسط وب برای جمع آوری و سازماندهی نشانک ها به سایت هایی در وب که برای شما با ارزش هستند فراهم می کند. می توانید بوک مارک ها را از طریق برچسب ها و پوشه ها و با استفاده از ویژگی جستجوی داخلی مرور کنید و فیلتر کنید. برای دسترسی به نشانک های خود در هر نقطه ، به شما امکان می دهد از طریق API REST داخلی - با برنامه های داخلی REST - با مرورگر یا تلفن خود همگام سازی کنید. - مشتری های شخص ثالث را که در اینجا ذکر شده است بررسی کنید. : //github.com/nextcloud/bookmarks#third-party-clientsRequirements: - PHP v7.1 + - پسوند PHP: - gmp: * - intl: * - mbstring: *",
    ...
    "RSS Feed" : "RSS Feed",
    "This is an RSS feed of the current result set with access restricted to you." : "این یک RSS feed از نتایج فعلی تنظیم شده با دسترسی محدود به شما است .",

OC.L10N.register(
    ...
    "This app provides you with a web interface for collecting, organizing and sharing bookmarks to the sites on the web that are precious to you.\nYou can browse and filter your bookmarks via tags, folders and by using the built-in search feature and you can share folders with other users and groups as well as create public links for them.\nAlso, in order to access your bookmarks anywhere, it also allows you to synchronize with third-party clients via a built-in REST API -- be it in your browsers or on your phone.\nCheck out the third-party clients listed here: https://github.com/nextcloud/bookmarks#third-party-clients\n\nRequirements:\n - PHP v7.3+\n - PHP extensions:\n   - intl: *\n   - mbstring: *\n - Nextcloud v20+" : "Questa applicazione ti offre un'interfaccia web per raccogliere, organizzare e condividere segnalibri di siti web che sono importanti per te.\nPuoi sfogliare e filtrare i segnalibri per etichette, cartelle o usando la funzione di ricerca integrata e puoi condividere le cartelle con altri utenti e gruppi, oppure creare collegamenti pubblici per essi.\nInoltre, per accedere ai tuoi segnalibri ovunque, ti permette anche di sincronizzarli con client di terze parti usando API REST integrate -- sia dal browser che dal telefono.\nDai un'occhiata ai client di terze parti elencati qui: https://github.com/nextcloud/bookmarks#third-party-clients\n\nRequisiti:\n - PHP v7.3+\n - Estensioni PHP:\n   - intl: *\n   - mbstring: *\n - Nextcloud v20+",
    ...
    "Sort by click count" : "Ordina per numero di click",
    ...
    "_%n bookmark_::_%n bookmarks_" : ["1%n segnalibro","1%n segnalibri"],
    ...
    "Start by importing bookmarks from a file or synchronizing your browser bookmarks with this app" : "Inizia importando i segnalibri da un file o sincronizzando quelli del tuo browser con questa applicazione",

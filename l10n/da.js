OC.L10N.register(
    ...
    "This app allows you to manage links to your favorite places on the web." : "Denne app giver dig mulighed for at administrere links til dine yndlingssteder på nettet.",
    "Sort your bookmarks into folders, label them with tags and share them with others! The app will regularly check all your links for availability and display unavailable links. If you add a link to a file on the web, the file will be automatically downloaded to your Nextcloud Files. You can also import bookmarks exported from other services or directly sync bookmarks from all your browsers with this app." : "Sorter dine bogmærker i mapper, mærk dem med tags og del dem med andre! Appen vil regelmæssigt tjekke alle dine links for tilgængelighed og vise utilgængelige links. Hvis du tilføjer et link til en fil på nettet, vil filen automatisk blive downloadet til dine Nextcloud-filer. Du kan også importere bogmærker eksporteret fra andre tjenester eller direkte synkronisere bogmærker fra alle dine browsere med denne app.",

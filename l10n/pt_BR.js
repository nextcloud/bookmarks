OC.L10N.register(
    ...
    "Try changing your query or add some using the button on the left." : "Tente alterar sua consulta ou adicionar alguma usando o botão à esquerda.",
    ...
    "RSS Feed" : "Feed RSS",
    "This is an RSS feed of the current result set with access restricted to you." : "Este é um feed RSS do conjunto atual de resultados com acesso restrito a você.",
    "Clear data" : "Limpar dados",
    "Permanently remove all bookmarks from your account. There is no going back!" : "Excluir permanentemente todos os favoritos da sua conta. Não há como desfazer isso!",
    ...
    "Select" : "Selecionar",
    "Previews" : "Prévias",
    "In order to display real screenshots of your bookmarked websites, Bookmarks can use a third-party service to generate those." : "Para exibir capturas reais de tela de seus favoritos, os Favoritos podem usar um serviço de terceiros para gerá-las.",
    "Screeenly" : "Screeenly",

OC.L10N.register(
    ...
    "Frequent bookmarks" : "Marcadores frequentes ",
    ...
    "This app provides you with a web interface for collecting, organizing and sharing bookmarks to the sites on the web that are precious to you.\nYou can browse and filter your bookmarks via tags, folders and by using the built-in search feature and you can share folders with other users and groups as well as create public links for them.\nAlso, in order to access your bookmarks anywhere, it also allows you to synchronize with third-party clients via a built-in REST API -- be it in your browsers or on your phone.\nCheck out the third-party clients listed here: https://github.com/nextcloud/bookmarks#third-party-clients\n\nRequirements:\n - PHP v7.3+\n - PHP extensions:\n   - intl: *\n   - mbstring: *\n - Nextcloud v20+" : "Este aplicativo apresenta uma interface web para coleção, organização e compartilhamento de favoritos de sites da web que você considera importantes.\nVocê pode navegar e filtrar seus favoritos através de etiquetas (tags), pastas e a partir do recurso de pesquisa embutido, permitindo-lhe compartilhar pastas com outras pessoas ou grupos, assim como criar links públicos para eles.\nAlém disso, a fim de acessar seus favoritos em qualquer lugar, ela também permite sincronização com clientes de terceiros através de uma API REST integrada -- seja em seus navegadores ou em seu celular.\nConfira aqui a lista de clientes de terceiros: https://github.com/nextcloud/bookmarks#third-party-clients\n\nRequisitos:\n - PHP v7.3+\n - PHP extensions:\n   - intl: *\n   - mbstring: *\n - Nextcloud v20+",
    ...
    "The RSS feed requires authentication with your Nextcloud credentials" : "O alimentador RSS requer autenticação com suas credenciais Nextcloud",
    "Sort by created date" : "Classificar por data de criação",
    ...
    "Start by importing bookmarks from a file or synchronizing your browser bookmarks with this app" : "Comece importando favoritos de um arquivo ou sincronizando os favoritos do seu navegador com este aplicativo",

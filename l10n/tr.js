OC.L10N.register(
    ...
    "- 📂 Browse and filter your bookmarks via tags and folders and add personal notes\n- 🔍 Built-in full-text search integrated into Nextcloud's unified search\n- 👪 Share bookmarks with other users as well as publicly\n- 💡 Keep track of changes in the activity stream\n- ☠ Easily find broken links\n- 📔 All your links are automatically archived for full-text search and in case they are depublished\n- 📲 Access your bookmarks anywhere, on desktop Browsers and on your phone, via a variety of sync clients\n- 💼 Built-in Dashboard widgets for frequent and recent links\n- ⚛ Easily generate public and private RSS feeds of your collections\n\nRequirements:\n - PHP v7.3+\n - PHP extensions:\n   - intl: *\n   - mbstring: *\n - Nextcloud v20+" : "- 📂 Etiket ve klasörler kullanarak yer imlerinize göz atın, süzün ve kişisel notlar ekleyin\n- 🔍 Birleşik Nextcloud aramasıyla bütünleşik yerleşik tam metin arama\n- 👪 Yer imlerini diğer kullanıcılarla ve herkese açık olarak paylaşın\n- 💡 Etkinlik akışındaki gelişmeleri izleyin\n- ☠ Bozuk bağlantıları kolayca bulun\n- 📔 Tüm bağlantılarınız yayından kaldırılmaları durumunda tam metin araması için  otomatik olarak arşivlenir\n- 📲 Çeşitli eşitleme istemcileri aracılığıyla yer imlerinize her yerden, masaüstü tarayıcılardan ve telefonunuzdan erişin\n- 💼 Sık ve son kullanılan bağlantılar için yerleşik pano gereçleri\n- ⚛ Derlemelerinizden kolayca genel ve özel RSS akışları oluşturun\n\nGereksinimler:\n - PHP v7.3+\n - PHP eklentileri:\n   - intl: *\n   - mbstring: *\n - Nextcloud v20+",

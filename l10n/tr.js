OC.L10N.register(
    ...
    "%1$s deleted \"%1$s\"" : "%1$s, \"%1$s\" yer imini sildi",
    ...
    "In order to display real screenshots of your bookmarked websites, Bookmarks can use third-party services to generate previews." : "Yer imleri, kayıt edilmiş websitelerine ait gerçek ekran görüntülerini göstermek  için 3.parti servisleri kullanabilir.",
    "Screeenly" : "Screeenly",
    ...
    "Performance" : "Başarım",
    "In an installation with a lot of users it may be useful to restrict the number of bookmarks per account." : "Çok fazla kullanıcının bulunduğu yüklemelerde, yer imlerini hesap başına olacak şekilde limitlemek faydalı olacaktır.",
    ...
    "Failed to rename tag" : "Etiket yeniden adlandırma hatası",

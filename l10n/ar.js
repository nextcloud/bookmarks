OC.L10N.register(
    ...
    "- 📂 Sort bookmarks into folders\n- 🏷 Add tags and personal notes\n- 🔍 Full-text search\n- 📲 Synchronize with all your browsers and devices\n- 👪 Share bookmarks with other users and publicly\n- ☠ Find broken links\n- ⚛ Generate RSS feeds of your collections\n- 📔 Read archived versions of your links in case they are depublished\n- 💬 Create new bookmarks directly from within Nextcloud Talk\n- 💼 Built-in Dashboard widgets for frequent and recent links\n\nRequirements:\n - PHP v7.4+\n - PHP extensions:\n   - intl: *\n   - mbstring: *\n - when using MySQL, use at least v8.0" : "- 📂 فرز الإشارات المرجعية في مجلدات \n- 🏷 إضافة العلامات والملاحظات الشخصية \n- 🔍 \"البحث عن نص كامل\" \n- 📲 مزامنة مع جميع المتصفحات والأجهزة الخاصة بك \n- 👪 مشاركة الإشارات المرجعية مع مستخدمين آخرين و مع عموم الجمهور \n- ☠ الكشف عن الروابط المعطلة \n- ⚛ إنشاء موجزات RSS لمجموعاتك \n- 📔 قراءة النسخ المؤرشفة من الروابط الخاصة بك في حالة عدم نشرها \n- 💬 إنشاء إشارات مرجعية جديدة مباشرة من داخل تطبيق نكست كلاود للمحادثة Talk\n- 💼 ودجات مبنية builin widgets في لوحة القيادة للروابط المتكررة و آخر ما تمّ تأشيره\n\nالمتطلبات: \n- PHP v7.4 + \n- ملحقات PHP: \n- دولي: * \n- mbstring: * \n- عند استخدام MySQL ، استخدم v8.0 على الأقل",

OC.L10N.register(
    ...
    "- 📂 Sort bookmarks into folders\n- 🏷 Add tags and personal notes\n- ☠ Find broken links and duplicates\n- 📲 Synchronize with all your browsers and devices\n- 📔 Store archived versions of your links in case they are depublished\n- 🔍 Full-text search on site contents\n- 👪 Share bookmarks with other users, groups and teams or via public links\n- ⚛ Generate RSS feeds of your collections\n- 📈 Stats on how often you access which links\n- 🔒 Automatic backups of your bookmarks collection\n- 💼 Built-in Dashboard widgets for frequent and recent links\n\nRequirements:\n - PHP extensions:\n   - intl: *\n   - mbstring: *\n - when using MySQL, use at least v8.0" : "- 📂 فرز الإشارات المرجعية إلى مجلدات \n- 🏷 إضافة علامات وملاحظات شخصية \n- ☠ البحث عن الروابط المعطلة والمكررة \n- 📲 المزامنة مع جميع متصفحاتك وأجهزتك \n- 📔 تخزين الإصدارات المؤرشفة من الروابط الخاصة بك في حالة إلغاء نشرها \n- 🔍 البحث عن النص الكامل في محتويات الموقع \n- 👪 مشاركة الإشارات المرجعية مع مستخدمين ومجموعات وفرق أخرى أو عبر الروابط العامة \n- ⚛ إنشاء موجزات RSS لمجموعاتك \n- 📈 إحصائيات حول عدد مرات وصولك إلى الروابط \n- 🔒 نسخ احتياطية تلقائية لمجموعة الإشارات المرجعية الخاصة بك \n- 💼 أدوات لوحة معلومات مدمجة للروابط المتكررة والحديثة \n\nالمتطلبات: \n- ملحقات PHP: - intl: * \n- mbstring: * \n- عند استخدام MySQL، استخدم الإصدار v8.0 على الأقل",

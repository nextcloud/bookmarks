OC.L10N.register(
    ...
    "- 📂 Sort bookmarks into folders\n- 🏷 Add tags and personal notes\n- 🔍 Full-text search on site contents\n- 📲 Synchronize with all your browsers and devices\n- 👪 Share bookmarks with other users and with public links\n- ☠ Find broken links and duplicates\n- ⚛ Generate RSS feeds of your collections\n- 📈 Stats on how often you access which links\n- 📔 Store archived versions of your links in case they are depublished\n- 🔒 Automatic backups of your bookmarks\n- 💬 Create new bookmarks directly from within Nextcloud Talkhe\n- 💼 Built-in Dashboard widgets for frequent and recent links\n\n\nRequirements:\n - PHP extensions:\n   - intl: *\n   - mbstring: *\n - when using MySQL, use at least v8.0" : "-📂فرز و ترتيب العلامات المرجعية في مجلدات \n- 🏷 التوسيم و إضافة الملاحظات الشخصية \n- 🔍 البحث النصي الكامل في محتويات الموقع \n- 📲 المزامنة مع جميع متصفحاتك و أجهزتك \n- 👪 مشاركة الإشارات المرجعية مع مستخدمين آخرين و مع الروابط العامة \n- ☠ البحث عن الروابط المعطلة و التكرارات \n- ⚛ إنشاء خلاصات RSS لمجموعاتك \n- 📈 إحصائيات حول عدد المرات التي تدخل فيها إلى الروابط \n- 📔 حفظ الإصدارات المؤرشفة من روابطك في حالة إعادة نشرها \n- 🔒 النسخ الاحتياطي التلقائي لإشاراتك المرجعية \n- 💬 إنشاء إشارات مرجعية جديدة مباشرة من داخل نكست كلاود \n- 💼 عناصر واجهة مستخدم مدمجة في لوحة التحكم للروابط المتكررة والحديثة \n\nالمتطلبات: \n- ملحقات PHP: \n     - intl: *\n     - mbstring: * \n- عند استخدام MySQL، استخدم الإصدار 8.0 على الأقل",

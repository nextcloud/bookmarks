OC.L10N.register(
    ...
    "- 📂 Sort bookmarks into folders\n- 🏷 Add tags and personal notes\n- ☠ Find broken links and duplicates\n- 📲 Synchronize with all your browsers and devices\n- 📔 Store archived versions of your links in case they are depublished\n- 🔍 Full-text search on site contents\n- 👪 Share bookmarks with other users and via public links\n- ⚛ Generate RSS feeds of your collections\n- 📈 Stats on how often you access which links\n- 🔒 Automatic backups of your bookmarks collection\n- 💼 Built-in Dashboard widgets for frequent and recent links\n\nRequirements:\n - PHP extensions:\n   - intl: *\n   - mbstring: *\n - when using MySQL, use at least v8.0" : "-📂 فرز الإشارات المرجعية في مجلدات\n- 🏷 إضافة الوسوم والملاحظات الشخصية \n- ☠ البحث عن الروابط المعطلة والنسخ المكررة \n- 📲 المزامنة بين جميع متصفحاتك و أجهزتك \n- 📔 تخزين الإصدارات المؤرشفة من روابطك في حالة إعادة نشرها \n- 🔍 البحث النصي الكامل في محتويات الموقع \n- 👪 مشاركة الإشارات المرجعية مع مستخدمين آخرين وعبر الروابط العامة \n- ⚛ إنشاء موجزات RSS لمجموعاتك \n- 📈 إحصائيات حول عدد المرات التي دخلت فيها إلى الروابط \n- 🔒 نسخ احتياطي تلقائي لمجموعة الإشارات المرجعية الخاصة بك \n- 💼 عناصر واجهة مستخدم مدمجة في لوحة التحكم للروابط المتكررة والحديثة \n\nالمتطلبات: \n- ملحقات PHP التالية: \n          - intl: *\n         - mbstring: *\n- عند استعمال MySQL، استعمل الإصدار 8.0 فما فوق",

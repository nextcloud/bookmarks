OC.L10N.register(
    ...
    "RSS Feed" : "Flux RSS",
    "This is an RSS feed of the current result set with access restricted to you." : "Ceci est un flux RSS des résultats actuels dont l'accès vous est réservé.",
    ...
    "In order to display real screenshots of your bookmarked websites, Bookmarks can use a third-party service to generate those." : "Afin d'afficher des captures d'écran réelles de vos signets, Bookmarks peut utiliser un service tiers pour les générer.",
    "Screeenly" : "Screeenly",
    ...
    "In an installation with  a lot of users it may be useful to restrict the number of bookmarks per account." : "Dans une installation avec beaucoup d'utilisateurs, il peut être utile de limiter le nombre de signets par compte.",

OC.L10N.register(
    ...
    "This app provides you with a web interface for collecting and organizing bookmarks to the sites on the web that are precious to you.\nYou can browse and filter your bookmarks via tags and folders and by using the built-in search feature.\nAlso, in order to access your bookmarks anywhere, it also allows you to synchronize with third-party clients via a built-in REST API -- be it in your browsers or on your phone.\nCheck out the third-party clients listed here: https://github.com/nextcloud/bookmarks#third-party-clients\n\nRequirements:\n - PHP v7.1+\n - PHP extensions:\n   - gmp: *\n   - intl: *\n   - mbstring: *" : "Cette application vous offre une interface Web pour collecter et organiser des signets vers vos sites Web préférés.\nVous pouvez parcourir et filtrer vos signets via des balises et des dossiers et en utilisant la fonction de recherche intégrée\nafin d'accéder à vos signets de n'importe où, il vous permet également de vous synchroniser avec des clients tiers via une API REST intégrée - que ce soit dans vos navigateurs web ou sur votre téléphone.\nDécouvrez les clients tiers répertoriés ici: https : //github.com/nextcloud/bookmarks#third-party-clients\n\nConditions requises: - PHP v7.1 +\n - Extensions PHP: \n- gmp: * \n- intl: *\n - mbstring: *",

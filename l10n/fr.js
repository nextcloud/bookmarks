OC.L10N.register(
    ...
    "- 📂 Browse and filter your bookmarks via tags and folders and add personal notes\n- 🔍 Built-in full-text search integrated into Nextcloud's unified search\n- 👪 Share bookmarks with other users as well as publicly\n- 💡 Keep track of changes in the activity stream\n- ☠ Easily find broken links\n- 📔 All your links are automatically archived for full-text search and in case they are depublished\n- 📲 Access your bookmarks anywhere, on desktop Browsers and on your phone, via a variety of sync clients\n- 💼 Built-in Dashboard widgets for frequent and recent links\n- ⚛ Easily generate public and private RSS feeds of your collections\n\nRequirements:\n - PHP v7.3+\n - PHP extensions:\n   - intl: *\n   - mbstring: *\n - Nextcloud v20+" : "- 📂 Parcourez et filtrez vos signets via des tags ainsi que les dossiers et ajoutez des notes personnelles\n- 🔍 Recherche complète intégrée dans la recherche unifiée NextCloud\n- 👪 Partagez vos signets avec d'autres utilisateurs et publiquement\n- 💡 Gardez une trace des changements dans le flux d'activité\n- ☠ Trouvez facilement les liens cassés\n- 📔 Tous vos liens sont archivés automatiquement pour une recherche complète au cas où ils seraient retirés\n- 📲 Accédez à vos signets de partout,depuis votre navigateur et votre téléphone, via une variété de clients de synchronisation\n- 💼 Widgets de tableau de bord intégrés pour les liens récents et ceux visités récemment\n- ⚛ Générez rapidement un flux RSS public de vos collections\n\nPré-requis:\n- PHP v7.3+\n- Extensions PHP:\n- intl: *\n- mbstring: *\n- Nextcloud v20+",
    ...
    "_Adding %n bookmark to new folder_::_Adding %n bookmarks to new folder_" : ["Ajout de %n favori au nouveau dossier","Ajout de %n favoris au nouveau dossier"],

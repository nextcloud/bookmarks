OC.L10N.register(
    ...
    "Put folder into trashbin" : "Mettre le dossier dans la poubelle",
    ...
    "Bookmarks Settings" : "Bookmarks Paramètres",
    ...
    "Your search yielded no results in the current folder." : "Votre recherche n’a produit aucun résultat dans le dossier actuel.",
    "No broken links" : "Aucun lien brisé",
    "No shared folders" : "Aucun dossier partagé",
    "No duplicated bookmarks" : "Aucun favori en double",
    "No deleted bookmarks" : "Aucun favoris supprimés",
    ...
    "The bookmarks app can automatically archive the web content of links you have bookmarked" : "L’application bookmarks peut automatiquement archiver le contenu Web des liens que vous avez marqué",
    ...
    "Currently your administrator has disabled network access for this app, however, which is why Auto-archiving is disabled at the moment." : "Actuellement, votre administrateur a désactivé l'accès au réseau pour cette application, c'est pourquoi l'archivage automatique est actuellement désactivé.",
    "Auto-Backup" : "Sauvegarde automatique",
    "The bookmarks app can automatically backup your bookmarks on a daily basis to prevent data loss when syncing bookmarks across devices." : "L’application bookmarks peut automatiquement sauvegarder vos favoris sur une base quotidienne pour éviter la perte de données lors de la synchronisation des favoris entre les appareils.",
    ...
    "The bookmarks app can automatically make available the textual contents of the websites you bookmark to Context Chat, which allows asking questions about and getting answers based on those contents. This is only available if auto-archiving is enabled." : "L'application Signets peut automatiquement mettre à disposition le contenu des sites web que vous ajoutez à vos signets dans le chat contextuel, ce qui vous permet de poser des questions et d'obtenir des réponses basées sur ce contenu. Cette fonctionnalité n'est disponible que si l'archivage automatique est activé.",
    ...
    "If you have problems with this Bookmarks app or have an idea about what could be improved, don't hesitate to get in touch by clicking here." : "Si vous avez des problèmes avec cette application Bookmarks ou si vous avez une idée de ce qui pourrait être amélioré, n’hésitez pas à nous contacter en cliquant ici.",
    "Support this project" : "Soutenir ce projet",
    "My work on this Bookmarks app is fuelled by a voluntary subscription model. If you think what I do is worthwhile, I would be happy if you could support my work. Also, please consider giving the app a review on the Nextcloud app store. Thank you 💙 " : "Mon travail sur cette application est alimenté par un modèle d’abonnement volontaire. Si vous pensez que ce que je fais en vaut la peine, je serais heureux si vous pouviez soutenir mon travail. En outre, veuillez envisager de donner à l’application un avis sur l’app store Nextcloud. Merci 💙 ",
    ...
    "Privacy" : "Vie privée",
    "The app will try to access web pages that you add to automatically add information about them." : "L'application tentera d'accéder aux pages Web que vous ajoutez pour ajouter automatiquement des informations les concernant.",
    ...
    "Failed to count bookmarks" : "Échec du décompte des marque-pages",
    ...
    "Failed to restore bookmark" : "Échec de la restauration du marque-page",
    ...
    "Failed to restore folder" : "Échec de la restauration du dossier",
    "Failed to create folder" : "Impossible de créer le dossier",
    "Failed to load children order" : "Échec du chargement de l'ordre des enfants",
    "Failed to move parts of selection" : "Impossible de déplacer la sélection",
    "Failed to copy parts of selection" : "Échec de la copie de certaines parties de la sélection",
    "Failed to delete parts of selection" : "Impossible de supprimer les éléments de la sélection",
    "Failed to tag parts of selection" : "Échec du tag de certaines parties de la sélection",
    "Failed to fetch bookmarks." : "Impossible de récupérer les signets.",
    "Failed to store setting" : "Échec de l’enregistrement des paramètres",
    "Failed to load setting {key}" : "Échec du chargement du paramètre {key}",
    "Failed to create share for folder {folderId}" : "Échec de la création du partage pour le dossier {folderId}",
    ...
    "Failed to create public link for folder {folderId}" : "Échec de la création du lien public pour le dossier {folderId}",
    "Failed to delete public link for folder {folderId}" : "Échec de la suppression du lien public pour le dossier {folderId}",
    "Failed to permanently delete parts of trash bin" : "Impossible de supprimer définitivement certaines parties de la corbeille",

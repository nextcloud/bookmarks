OC.L10N.register(
    ...
    "Imported bookmarks" : "סימניות מיובאות",
    ...
    "Try changing your query or add some using the button on the left." : "כדאי לנסות לערוך את השאילתה או להוסיף שאילתה בעזרת הכםתור שמימין.",
    ...
    "Select all visible" : "בחירת כל הגלויות",
    ...
    "Shared privately" : "שותפה בפרטיות",
    "Public" : "ציבורי",
    ...
    "RSS Feed" : "ערוץ RSS",
    "This is an RSS feed of the current result set with access restricted to you." : "זו הזנת RSS של סדרת התוצאות הנוכחית כשהגישה מותרת לך בלבד.",
    ...
    "Performance" : "ביצועים",
    "In an installation with  a lot of users it may be useful to restrict the number of bookmarks per account." : "בהתקנה עם הרבה משתמשים ייתכן שעדיף להגביל את כמות הסימניות לחשבון.",
    ...
    "Failed to move parts of selection" : "העברת חלקים מהבחירה נכשלה",
    "Failed to delete parts of selection" : "מחיקת חלקים מהבחירה נכשלה",

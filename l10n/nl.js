OC.L10N.register(
    ...
    "- 📂 Browse and filter your bookmarks via tags and folders and add personal notes\n- 🔍 Built-in full-text search integrated into Nextcloud's unified search\n- 👪 Share bookmarks with other users as well as publicly\n- 💡 Keep track of changes in the activity stream\n- ☠ Easily find broken links\n- 📔 All your links are automatically archived for full-text search and in case they are depublished\n- 📲 Access your bookmarks anywhere, on desktop Browsers and on your phone, via a variety of sync clients\n- 💼 Built-in Dashboard widgets for frequent and recent links\n- ⚛ Easily generate public and private RSS feeds of your collections\n\nRequirements:\n - PHP v7.3+\n - PHP extensions:\n   - intl: *\n   - mbstring: *\n - Nextcloud v20+" : "- 📂 Browse en filter je bladwijzers via labels en mappen en persoonlijke notities\n- 🔍 Ingebouwde volledige tekst zoekfunctie geïntegreerd in Nextclouds verenigd zoeken\n- 👪 Deel bladwijzers met andere gebruikers en publiekelijk\n- 💡 Houd veranderingen bij in de activiteiten stream\n- ☠ Vind ongeldige links gemakkelijk\n- 📔 Al je links worden automatisch gearchiveerd voor de volledige tekst zoekfunctie in het geval ze gedepubliceerd worden\n- 📲 Overal toegang tot je bladwijzers, op desktop Browsers en op je telefoon, via een variëteit aan sync clients\n- 💼 ingebouwde Dashboard widgets voor veelgebruikte en recente links\n- ⚛ Genereer gemakelijk publieke- en privé-RSS feeds van je collecties\n\nVereisten:\n - PHP v7.3+\n - PHP extensies:\n   - intl: *\n   - mbstring: *\n - Nextcloud v20+",
    ...
    "Enter the path of a folder in your Files where bookmarked files should be stored." : "Voer de locatie van een map in je Bestanden in waar bladwijzers opgeslagen moeten worden.",

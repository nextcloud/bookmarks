OC.L10N.register(
    ...
    "Sort your bookmarks into folders, label them with tags and share them with others! The app will regularly check all your links for availability and display unavailable links. If you add a link to a file on the web, the file will be automatically downloaded to your Nextcloud Files. You can also import bookmarks exported from other services or directly sync bookmarks from all your browsers with this app." : "Sorteer je bladwijzers in mappen, label ze met tags en deel ze met anderen! De app controleert regelmatig al je links op beschikbaarheid en geeft niet-beschikbare links weer. Als je een link naar een bestand op internet toevoegt, wordt het bestand automatisch gedownload naar je Nextcloud-bestanden. Je kunt ook bladwijzers importeren die zijn geëxporteerd vanuit andere services of met deze app bladwijzers rechtstreeks synchroniseren vanuit al je browsers.",

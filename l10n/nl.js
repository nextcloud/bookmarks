OC.L10N.register(
    ...
    "Permanently remove all bookmarks from your account. There is no going back!" : "Verwijder permanent alle bookmarks van je account. Dit kan niet ongedaan worden gemaakt!",
    ...
    "In order to display real screenshots of your bookmarked websites, Bookmarks can use third-party services to generate previews." : "Om echte schermafbeeldingen van uw websites met bladwijzers weer te geven, kunnen bladwijzers services van derden gebruiken om voorbeelden te genereren.",
    "Screeenly" : "Screeenly",
    ...
    "Simply install the pageres cli on your server and bookmarks will find it." : "Installeer gewoon de pageres cli op uw server en de bladwijzers zullen het vinden.",
    "Privacy" : "Privacy",
    "Bookmarks will try to access web pages that you add to automatically add information about them." : "Bookmarks zal proberen toegang te krijgen tot webpagina's die u toevoegt om automatisch informatie over hen toe te voegen.",
    ...
    "Maximum allowed number of bookmarks per account. (0 for no limit; default is no limit)" : "Maximaal toegestaan aantal bookmark per account. (0 voor geen limiet; standaard is geen limiet)",
    "Failed to load settings" : "Kon instellingen niet laden",
    "Failed to save settings" : "Kon instellingen niet opslaan",
    "Add a bookmark" : "Voeg een bookmark toe",
    ...
    "Failed to find existing bookmark" : "Kon bestaande bookmark niet vinden",
    "Failed to create bookmark" : "Kon bookmark niet aanmaken",
    "Failed to save bookmark" : "Kon bookmark niet bewaren",
    "Failed to move bookmark" : "Kon bookmark niet verplaatsen",
    "Failed to delete bookmark" : "Kon bookmark niet verwijderen",
    "Failed to rename tag" : "Naam van label wijzigen mislukt",
    ...
    "Failed to fetch bookmarks." : "Kon bookmarks niet ophalen",

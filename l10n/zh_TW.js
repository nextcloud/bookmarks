OC.L10N.register(
    ...
    "Backup path" : "備份路徑",
    "Enter the path of a folder in your Files where your bookmarks backups will be stored." : "在「檔案」中輸入要儲存書籤備份的資料夾路徑。",
    "Client apps" : "客戶端應用程式",

OC.L10N.register(
    ...
    "Collect and manage bookmarks, synced with all your devices" : "Collect and manage bookmarks, synced with all your devices",
    ...
    "You have never clicked this link" : "You have never clicked this link",
    "You have clicked this link {count} times" : "You have clicked this link {count} times",
    "Details" : "ລາຍລະອຽດ",
    "Rename" : "ປ່ຽນຊື່",
    "Copy link" : "ສຳເນົາລິງ",
    "Move" : "ຍ້າຍ",
    "Add to folders" : "Add to folders",
    "Put bookmark into trash bin" : "Put bookmark into trash bin",
    "Restore bookmark" : "Restore bookmark",
    "Delete bookmark permanently" : "Delete bookmark permanently",
    ...
    "These are your deleted items. Items will be deleted permanently after two months." : "These are your deleted items. Items will be deleted permanently after two months.",
    ...
    "Searching in the current folder only." : "Searching in the current folder only.",
    "Repeat search in all folders" : "Repeat search in all folders",
    ...
    "_Selected %n bookmark_::_Selected %n bookmarks_" : ["Selected %n bookmarks"],
    "_Selected %n folder_::_Selected %n folders_" : ["Selected %n folder"],
    ...
    "Open folder details" : "Open folder details",
    ...
    "_Adding %n bookmark to new folder_::_Adding %n bookmarks to new folder_" : ["Adding %n bookmarks to new folder"],
    "Enter a link" : "Enter a link",
    "Enter a title" : "Enter a title",
    "No bookmarks found" : "No bookmarks found",
    "{folders} folders and {bookmarks} bookmarks" : "{folders} folders and {bookmarks} bookmarks",
    "_%n bookmark_::_%n bookmarks_" : ["%n bookmark"],
    ...
    "Do you really want to permanently delete this folder?" : "Do you really want to permanently delete this folder?",
    "Select folder" : "Select folder",
    "Enter folder title" : "Enter folder title",
    "Shared by {user}" : "ແບ່ງປັນໂດຍ {user}",
    "Rename folder" : "ປ່ຽນຊືໂຟນເດີ",
    "Move folder" : "Move folder",
    "Put folder into trashbin" : "Put folder into trashbin",
    "Restore folder" : "Restore folder",
    "Delete folder permanently" : "Delete folder permanently",
    ...
    "_Moving %n folder and some bookmarks_::_Moving %n folders and some bookmarks_" : ["Moving %n folder and some bookmarks"],
    "_Moving %n folder_::_Moving %n folders_" : ["Moving %n folders"],
    "_Moving %n bookmark_::_Moving %n bookmarks_" : ["Moving %n bookmarks"],
    ...
    "Bookmarks Settings" : "Bookmarks Settings",
    ...
    "Your search yielded no results in the current folder." : "Your search yielded no results in the current folder.",
    "No broken links" : "No broken links",
    "No shared folders" : "No shared folders",
    "No duplicated bookmarks" : "No duplicated bookmarks",
    "No deleted bookmarks" : "No deleted bookmarks",
    "You haven't deleted anything yet." : "You haven't deleted anything yet.",
    ...
    "The bookmarks app can automatically archive the web content of links you have bookmarked" : "The bookmarks app can automatically archive the web content of links you have bookmarked",
    ...
    "Currently your administrator has disabled network access for this app, however, which is why Auto-archiving is disabled at the moment." : "Currently your administrator has disabled network access for this app, however, which is why Auto-archiving is disabled at the moment.",
    "Auto-Backup" : "Auto-Backup",
    "The bookmarks app can automatically backup your bookmarks on a daily basis to prevent data loss when syncing bookmarks across devices." : "The bookmarks app can automatically backup your bookmarks on a daily basis to prevent data loss when syncing bookmarks across devices.",
    ...
    "Context Chat integration" : "Context Chat integration",
    "The bookmarks app can automatically make available the textual contents of the websites you bookmark to Context Chat, which allows asking questions about and getting answers based on those contents. This is only available if auto-archiving is enabled." : "The bookmarks app can automatically make available the textual contents of the websites you bookmark to Context Chat, which allows asking questions about and getting answers based on those contents. This is only available if auto-archiving is enabled.",
    "Context chat is currently not installed, but is required for this feature." : "Context chat is currently not installed, but is required for this feature.",
    "Enable Context Chat integration" : "Enable Context Chat integration",
    ...
    "If you have problems with this Bookmarks app or have an idea about what could be improved, don't hesitate to get in touch by clicking here." : "If you have problems with this Bookmarks app or have an idea about what could be improved, don't hesitate to get in touch by clicking here.",
    "Support this project" : "Support this project",
    "My work on this Bookmarks app is fuelled by a voluntary subscription model. If you think what I do is worthwhile, I would be happy if you could support my work. Also, please consider giving the app a review on the Nextcloud app store. Thank you 💙 " : "My work on this Bookmarks app is fuelled by a voluntary subscription model. If you think what I do is worthwhile, I would be happy if you could support my work. Also, please consider giving the app a review on the Nextcloud app store. Thank you 💙 ",
    ...
    "Privacy" : "ສ່ວນຕົວ",
    "The app will try to access web pages that you add to automatically add information about them." : "The app will try to access web pages that you add to automatically add information about them.",
    ...
    "Previews" : "Previews",
    "In order to display real screenshots of your bookmarked websites, the app can use third-party services to generate previews." : "In order to display real screenshots of your bookmarked websites, the app can use third-party services to generate previews.",
    "Screeenly" : "Screeenly",
    ...
    "Failed to restore bookmark" : "Failed to restore bookmark",
    ...
    "Failed to load deleted folders" : "Failed to load deleted folders",
    "Failed to load deleted bookmarks" : "Failed to load deleted bookmarks",
    "Failed to delete folder" : "Failed to delete folder",
    "Failed to move folder" : "Failed to move folder",
    "Failed to restore folder" : "Failed to restore folder",
    "Failed to create folder" : "Failed to create folder",
    "Failed to load children order" : "Failed to load children order",
    "Failed to move parts of selection" : "Failed to move parts of selection",
    "Failed to copy parts of selection" : "Failed to copy parts of selection",
    "Failed to delete parts of selection" : "Failed to delete parts of selection",
    "Failed to tag parts of selection" : "Failed to tag parts of selection",
    ...
    "Failed to create share for folder {folderId}" : "Failed to create share for folder {folderId}",
    ...
    "Failed to create public link for folder {folderId}" : "Failed to create public link for folder {folderId}",
    "Failed to delete public link for folder {folderId}" : "Failed to delete public link for folder {folderId}",
    "Failed to permanently delete parts of trash bin" : "Failed to permanently delete parts of trash bin",

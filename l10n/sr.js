OC.L10N.register(
    ...
    "RSS Feed" : "РСС довод",
    "This is an RSS feed of the current result set with access restricted to you." : "Ово је RSS довод тренутног скупа резултата ограничен на оне којима имате приступ.",
    ...
    "In an installation with  a lot of users it may be useful to restrict the number of bookmarks per account." : "У инсталација са много корисника може бити корисно да ограничите број обележивача по налогу.",
    ...
    "Failed to load setting " : "Грешка при учитавању поставки",

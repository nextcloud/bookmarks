OC.L10N.register(
    ...
    "- 📂 Sort bookmarks into folders\n- 🏷 Add tags and personal notes\n- 🔍 Full-text search\n- 📲 Synchronize with all your browsers and devices\n- 👪 Share bookmarks with other users and publicly\n- ☠ Find broken links\n- ⚛ Generate RSS feeds of your collections\n- 📔 Read archived versions of your links in case they are depublished\n- 💬 Create new bookmarks directly from within Nextcloud Talk\n- 💼 Built-in Dashboard widgets for frequent and recent links\n\nRequirements:\n - PHP v7.4+\n - PHP extensions:\n   - intl: *\n   - mbstring: *\n - when using MySQL, use at least v8.0" : "- 📂 Сортировка закладок по папкам\n- 🏷 Добавление тегов и личных заметок\n- 🔍 Полнотекстовый поиск\n- 📲 Синхронизация со всеми вашими браузерами и устройствами\n- 👪 Делитесь закладками с другими пользователями и по ссылкам\n- ☠ Поиск неработающих ссылок\n- ⚛ Создавайте RSS-каналы для ваших коллекций\n- 📔 Читайте архивные версии ваших ссылок, когда сами ресурсы удалены \n- 💬 Создавайте новые закладки из Nextcloud Talk\n- 💼 Встроенные виджеты панели мониторинга для частых и недавних закладок\nТребования:\n - PHP v7.4+\n - расширения для PHP:\n   - intl: *\n   - mbstring: *\n - при использовании MySQL, используйте версию не старше 8.0",
    ...
    "Enable bookmarks backups" : "Включить резервирование ссылок",
    ...
    "Link to a bookmark folder" : "Ссылка на папку с закладками",

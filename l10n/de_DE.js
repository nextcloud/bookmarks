OC.L10N.register(
    ...
    "Privacy" : "Datenschutz",
    "Bookmarks will try to access web pages that you add to automatically add information about them." : "Lesezeichen werden versuchen, automatisch auf die hinzugefügten Internetseiten zuzugreifen, um selbständig Informationen über diese Seiten hinzuzufügen.",
    ...
    "Previews" : "Vorschau",
    "In order to display real screenshots of your bookmarked websites, Bookmarks can use third-party services to generate previews." : "Um Screenshots Ihrer, mit Lesezeichen versehenen, Websites anzuzeigen, können Vorschaubilder mittels Drittanbieter-Diensten erstellt werden.",
    "Screeenly" : "Screeenly",
    ...
    "Simply install the Pageres CLI on your server and Bookmarks will find it. You can still add additional ENV vars to be fed to pageres, e.g. as indicated in the placeholder:" : "Installieren Sie einfach die Pageres-CLI auf Ihrem Server und Bookmarks wird sie erkennen. Sie können auch noch zusätzliche ENV-Variablen hinzufügen, die in Pageres verwandt werden, z.B. wie im Platzhalter angegeben:",

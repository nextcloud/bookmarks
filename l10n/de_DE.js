OC.L10N.register(
    ...
    "- 📂 Sort bookmarks into folders\n- 🏷 Add tags and personal notes\n- ☠ Find broken links and duplicates\n- 📲 Synchronize with all your browsers and devices\n- 📔 Store archived versions of your links in case they are depublished\n- 🔍 Full-text search on site contents\n- 👪 Share bookmarks with other users and via public links\n- ⚛ Generate RSS feeds of your collections\n- 📈 Stats on how often you access which links\n- 🔒 Automatic backups of your bookmarks collection\n- 💼 Built-in Dashboard widgets for frequent and recent links\n\nRequirements:\n - PHP extensions:\n   - intl: *\n   - mbstring: *\n - when using MySQL, use at least v8.0" : "- 📂 Lesezeichen in Ordner sortieren\n- 🏷 Schlagworte und persönliche Notizen hinzufügen\n- ☠ Defekte Links und Duplikate finden\n- 📲 Mit allen Ihren Browsern und Geräten synchronisieren\n- 📔 Archivierte Versionen Ihrer Links speichern, sofern die Seite offline geht\n- 🔍 Volltextsuche in Seiteninhalten\n- 👪 Lesezeichen mit anderen Personen und über öffentliche Links teilen\n- ⚛ RSS-Feeds Ihrer Sammlungen generieren\n- 📈 Statistiken, wie oft Sie auf welche Links zugreifen\n- 🔒 Automatische Datensicherungen der Lesezeichensammlung\n- 💼 Integrierte Dashboard-Widgets für häufige und aktuelle Links\n\nAnforderungen:\n - PHP-Erweiterungen:\n   - intl: *\n   - mbstring: *\n - bei Verwendung von MySQL mindestens v8.0 erforderlich",

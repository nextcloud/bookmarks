OC.L10N.register(
    ...
    "You unshared folder \"%1$s\" with %2$s" : "Sie haben die Freigabe des Ordnes \"%1$s\" für %2$s aufgehoben",
    "You unshared folder \"%s\" with someone" : "Sie haben die Freigabe des Ordners \"%s\" für jemanden aufgehoben",
    "%1$s unshared folder \"%2$s\" with you" : "%1$s hat die Freigabe des Ordnes \"%2$s\" aufgehoben",
    ...
    "- 📂 Browse and filter your bookmarks via tags and folders and add personal notes\n- 🔍 Built-in full-text search integrated into Nextcloud's unified search\n- 👪 Share bookmarks with other users as well as publicly\n- 💡 Keep track of changes in the activity stream\n- ☠ Easily find broken links\n- 📔 All your links are automatically archived for full-text search and in case they are depublished\n- 📲 Access your bookmarks anywhere, on desktop Browsers and on your phone, via a variety of sync clients\n- 💼 Built-in Dashboard widgets for frequent and recent links\n- ⚛ Easily generate public and private RSS feeds of your collections\n\nRequirements:\n - PHP v7.3+\n - PHP extensions:\n   - intl: *\n   - mbstring: *\n - Nextcloud v20+" : "- 📂 Durchsuchen und filtern Sie Ihre Lesezeichen mit Hilfe von Schlagworten und Ordnern und fügen Sie persönliche Notizen hinzu\n- 🔍 Integrierte Volltextsuche, die in die einheitliche Suche von Nextcloud integriert ist\n- 👪 Teilen Sie Ihre Lesezeichen mit anderen Nutzern und auch öffentlich\n- 💡 Verfolgung von Änderungen in der Aktivitätsanzeige\n- ☠ Fehlerhafte Links leicht finden\n- 📔 Alle Ihre Links werden automatisch für die Volltextsuche archiviert und für den Fall, dass sie nicht mehr veröffentlicht werden\n- 📲 Greifen Sie überall auf Ihre Lesezeichen zu, in Desktop-Browsern und auf Ihrem Handy, über eine Vielzahl von Synchronisierungsclients\n- 💼 Eingebaute Dashboard-Widgets für häufige und aktuelle Links\n- ⚛ Erstellen Sie ganz einfach öffentliche und private RSS-Feeds Ihrer Sammlungen\n\nVoraussetzungen:\n- PHP v7.3+\n- PHP-Erweiterungen:\n  - intl: *\n  - mbstring: *\n- Nextcloud v20+",
    ...
    "This app allows you to manage links to your favorite places on the web." : "Mit dieser App können Sie Links zu Ihren Lieblingsorten im Internet verwalten.",
    "Sort your bookmarks into folders, label them with tags and share them with others! The app will regularly check all your links for availability and display unavailable links. If you add a link to a file on the web, the file will be automatically downloaded to your Nextcloud Files. You can also import bookmarks exported from other services or directly sync bookmarks from all your browsers with this app." : "Sortieren Sie Ihre Lesezeichen in Ordnern, kennzeichnen Sie sie mit Schlagworten und teilen Sie sie mit anderen! Die App prüft regelmäßig alle Ihre Links auf Verfügbarkeit und zeigt nicht verfügbare Links an. Wenn Sie einen Link zu einer Datei im Internet hinzufügen, wird die Datei automatisch heruntergeladen und Ihren Nextcloud-Dateien hinzugefügt. Sie können auch Lesezeichen importieren, die von anderen Diensten exportiert wurden, oder Lesezeichen aus allen Ihren Browsern direkt mit dieser App synchronisieren.",
    ...
    "Permanently remove all bookmarks from your account." : "Entfernen Sie dauerhaft alle Lesezeichen aus Ihrem Konto.",

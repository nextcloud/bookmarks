OC.L10N.register(
    ...
    "Enter the path of a folder where bookmarked files should be stored" : "Iscrie su caminu de una cartella in ue diant dèpere èssere barigados is archìvios de is signalibros.",

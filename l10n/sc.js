OC.L10N.register(
    ...
    "This app provides you with a web interface for collecting, organizing and sharing bookmarks to the sites on the web that are precious to you.\nYou can browse and filter your bookmarks via tags, folders and by using the built-in search feature and you can share folders with other users and groups as well as create public links for them.\nAlso, in order to access your bookmarks anywhere, it also allows you to synchronize with third-party clients via a built-in REST API -- be it in your browsers or on your phone.\nCheck out the third-party clients listed here: https://github.com/nextcloud/bookmarks#third-party-clients\n\nRequirements:\n - PHP v7.3+\n - PHP extensions:\n   - intl: *\n   - mbstring: *\n - Nextcloud v20+" : "Custa aplicatzione t'oferit un'interfache in sa rete pro regollire, organizare e cumpartzire signalibros de sitos internet chi sunt de importu pro te.\nPodes chircare is sinnalibros intre etichetas, cartellas o impreende sa funtzione de chirca integrada e podes cumpartzire is cartellas cun àteros utentes e grupos, opuru creare ligòngios pùblicos pro custos.\nIn prus, pro atzèdere a is sinnalibros tuos in totue, ti permitet fintzas de ddos sincronizare cun clientes angenos impreende API REST integradas -- siat dae su navigadore chi dae su telèfono.\nCàstia a is clientes angenos elencados inoghe: https://github.com/nextcloud/bookmarks#third-party-clients\n\nRechisitos:\n - PHP v7.3+\n - estensiones PHP:\n   - intl: *\n   - mbstring: *\n - Nextcloud v20+",
    ...
    "List view" : "Bista elencu",
    "RSS Feed of current view" : "Fonte RSS de sa bista atuale",
    ...
    "Cancel selection" : "Cantzella seletzione",
    ...
    "No archived bookmarks" : "Perunu signalibru archiviadu",
    "Bookmarks to files like photos or PDFs will automatically be saved to your Nextcloud files, so you can still find them even when the link goes offline." : "Is signalibros pro archìvios che a fotos o PDF ant a èssere sarbados in automàticu in is archìvios tuos de Nextcloud, in manera chi tue ddos potzas agatare fintzas cando ses fora de lìnia.",
    "No bookmarks here" : "Perunu signalibru inoghe",
    "Start by importing bookmarks from a file or synchronizing your browser bookmarks with this app" : "Cumintza importende is signalibros dae un'archìviu o sincronizende cuddos de su navigadore tuo cun custa aplicatzione",
    "Import bookmarks" : "Importa signalibros",
    "Sync with your browser" : "Sincroniza cun su navigadore tuo",
    "Import" : "Importa",
    "Export" : "Esporta",
    "Sorting" : "Assentende",
    "Recently added" : "Agiuntu pagu ora",
    "Alphabetically" : "Òrdine alfabèticu",
    "Most visited" : "Prus bisitadu",
    "Last modified" : "Ùrtima modìfica",
    "Custom order" : "Òrdine personalizadu",
    "Archive path" : "Percursu archìviu",
    "Enter the path of a folder where bookmarked files should be stored" : "Iscrie su percursu de una cartella in ue diant dèpere èssere barigados is archìvios de is signalibros.",
    ...
    "Clear data" : "Lìmpia is datos",
    "Permanently remove all bookmarks from your account." : "Boga totu is signalibros de su contu tuo de su totu.",
    "Delete all bookmarks" : "Cantzella totu is signalibros",
    "Do you really want to delete all your bookmarks?" : "A beru cheres cantzellare totu is signalibros?",
    ...
    "Archived version" : "Versione archiviada",
    "Open archived file" : "Aberi archìvios barigados",
    "Notes" : "Notas",
    "Notes for this bookmark …" : "Notas pro custu signalibru ...",
    "{time} ago" : "{time} a como",
    "Owner" : "Mere",
    ...
    "Allow sharing" : "Permiti sa cumpartzidura",
    ...
    "Failed to save bookmark" : "No at fatu a sarbare signalibru",
    ...
    "Failed to change setting" : "No at fatu a cambiare is impostatziones",
    "Failed to load setting {key}" : "No at fatu a carrigare is impostatziones {key}",

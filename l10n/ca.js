OC.L10N.register(
    ...
    "_%n bookmark_::_%n bookmarks_" : ["%n marcador","%n adreces d'interès"],
    ...
    "Sort your bookmarks into folders, label them with tags and share them with others! The app will regularly check all your links for availability and display unavailable links. If you add a link to a file on the web, the file will be automatically downloaded to your Nextcloud Files. You can also import bookmarks exported from other services or directly sync bookmarks from all your browsers with this app." : "Ordena les teves adreces d'interès en carpetes, etiqueta'ls amb etiquetes i comparteix-les amb els altres! L'aplicació comprovarà regularment la disponibilitat de tots els vostres enllaços i mostrarà els enllaços no disponibles. Si afegiu un enllaç a un fitxer a la web, el fitxer es baixarà automàticament als vostres fitxers Nextcloud. També podeu importar adreces d'interès exportades des d'altres serveis o sincronitzar directament les adreces d'interès de tots els vostres navegadors amb aquesta aplicació.",

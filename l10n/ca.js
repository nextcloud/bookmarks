OC.L10N.register(
    ...
    "This app provides you with a web interface for collecting, organizing and sharing bookmarks to the sites on the web that are precious to you.\nYou can browse and filter your bookmarks via tags, folders and by using the built-in search feature and you can share folders with other users and groups as well as create public links for them.\nAlso, in order to access your bookmarks anywhere, it also allows you to synchronize with third-party clients via a built-in REST API -- be it in your browsers or on your phone.\nCheck out the third-party clients listed here: https://github.com/nextcloud/bookmarks#third-party-clients\n\nRequirements:\n - PHP v7.2+\n - PHP extensions:\n   - intl: *\n   - mbstring: *\n - Nextcloud v17+" : "Aquesta aplicació li proporciona una interfície web per recopilar, organitzar i compartir adreces d’interès als llocs de la web que són valuosos per a vostè.\nPodeu navegar i filtrar les adreces d'interès a través d'etiquetes, carpetes i utilitzant la funció de cerca integrada i podeu compartir carpetes amb altres usuaris i grups, així com crear enllaços públics per a ells.\nA més, per accedir a les adreces d'interès en qualsevol lloc, també li permet sincronitzar amb clients de tercers a través d'una API REST integrada -- ja sigui en els seus navegadors o en el seu telèfon.\nPodeu revisar una revisió dels clients de tercers que figuren aquí: https://github.com/nextcloud/bookmarks#third-party-clients\n\nRequisits:\n - PHP v7.2+\n - Extensions PHP:\n   - intl: *\n   - mbstring: *\n - Nextcloud v17+",
    ...
    "Allow sharing" : "Permet compartir",
    ...
    "Simply install the pageres cli on your server and bookmarks will find it." : "Simplement instal·leu els pageres cli al vostre servidor i els marcadors el trobaran.",
    "Privacy" : "Privadesa",
    ...
    "Title" : "Títol",
    "Link" : "Enllaç",
    "Enter bookmark URL" : "Introduïu l'adreça URL de les adreces d'interès",
    "Folder" : "Carpeta",

OC.L10N.register(
    ...
    "Delete" : "Suprimeix",
    "Saved" : "Desat",
    "Date added" : "S'ha afegit la data",
    "Link" : "Enllaç",
    "Tags" : "Etiquetes",
    ...
    "Recently added" : "S'ha afegit recentment",
    "Most visited" : "El més visitat",
    "View mode" : "Mode de visualització",
    "List view" : "Mode de la llista",
    "RSS Feed" : "Canal RSS",
    ...
    "An error occurred while trying to save the bookmark." : "S'ha produït un error mentre es desava l'adreça d'interès.",
    "Error" : "Error",
    "Uncategorized" : "No té categoria",
    "Error parsing the import result" : "S'ha produït un error mentre s'analitzava el resultat de la importació",
    "Import completed successfully." : "L'ha importació s'ha completat correctament.",
    "Do you really want to delete all your bookmarks?" : "Esteu segurs de voler suprimir totes les vostres adreces d'interès?",
    ...
    "Add a bookmark" : "Afegeix una adreça d'interès",
    "This URL is already bookmarked! Overwrite?" : "Aquesta URL ja la teniu a les adreces d'interès!, la voleu sobreescriure?",
    ...
    "Screenly API URL" : "URL de l'API Screenly",
    "Screenly API key" : "Clau de l'API Screenly",

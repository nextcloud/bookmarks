OC.L10N.register(
    ...
    "This app provides you with a web interface for collecting and organizing bookmarks to the sites on the web that are precious to you. You can browse and filter your bookmarks via tags and folders and by using the built-in search feature. Furthermore, in order to access your bookmarks anywhere, it also allows you to synchronize third-party clients via a built-in REST API -- in your browsers and on your phone.\n\nCheck out the third-party clients listed here: https://github.com/nextcloud/bookmarks#third-party-clients" : "Aquesta aplicació t'ofereix una interfície web per tal de recopilar i organitzar els teus enllaços web favorits. Pots visualitzar i filtrar els teus favorits mitjançant etiquetes i carpetes així com utilitzar la funció integrada de cerca. A més, per poder accedir als teus favorits des de qualsevol lloc, sigui en navegadors o en dispositius mòbils, pots sincronitzar-los utilitzant aplicacions de tercers mitjançant l'API integrada.\n\nPots comprovar totes les aplicacions de tercers disponibles en el següent enllaç: https://github.com/nextcloud/bookmarks#third-party-clients",

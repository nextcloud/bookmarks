OC.L10N.register(
    ...
    "Try changing your query or add some using the button on the left." : "Reyndu að breyta fyrirspurninni eða bæta við skilyrðum með því að nota hnappinn til vinstri..",
    ...
    "Select all visible" : "Velja allt sýnilegt",
    ...
    "Shared privately" : "Deilt sem einkamáli",
    "Public" : "Opinbert",
    ...
    "This is an RSS feed of the current result set with access restricted to you." : "Þetta er RSS-streymi með fyrirliggjandi niðurstöður þar sem aðgangur er takmarkaður við þig.",
    ...
    "Privacy" : "Gagnaleynd",
    "Bookmarks will try to access web pages that you add to automatically add information about them." : "Bókamerkjaforritið mun reyna að fá aðgang að þeim síðum sem þú bætir við til að sækja sjálfvirkt upplýsingar um þær.",

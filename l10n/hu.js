OC.L10N.register(
    ...
    "- 📂 Sort bookmarks into folders\n- 🏷 Add tags and personal notes\n- 🔍 Full-text search\n- 📲 Synchronize with all your browsers and devices\n- 👪 Share bookmarks with other users and publicly\n- ☠ Find broken links\n- ⚛ Generate RSS feeds of your collections\n- 📔 Read archived versions of your links in case they are depublished\n- 💬 Create new bookmarks directly from within Nextcloud Talk\n- 💼 Built-in Dashboard widgets for frequent and recent links\n\nRequirements:\n - PHP v7.3+\n - PHP extensions:\n   - intl: *\n   - mbstring: *\n - Nextcloud v20+" : "- 📂 Könyvjelzők mappákba rendezése\n- 🏷 Címkék és személyes jegyzetek hozzáadása\n- 🔍 Teljes szöveges keresés\n- 📲 Szinkronizálás az összes böngészővel és eszközzel\n- 👪 Könyvjelzők megosztása más felhasználókkal és nyilvánosan\n- ☠ Törött hivatkozások keresése\n- ⚛ RSS-hírforrások előállítása a gyűjteményekből\n- 📔 Hivatkozások archivált változatának olvasása, ha már nincsenek közzétéve\n- 💬 Új könyvjelzők létrehozása közvetlenül a Nextcloud Beszélgetésből\n- 💼 Beépített irányítópult modulok a gyakran használt és friss hivatkozásokhoz\n\nKötelmények:\n - PHP v7.3+\n - PHP bővítmények:\n   - intl: *\n   - mbstring: *\n - Nextcloud v20+",
    ...
    "Enter the path of a folder in your Files where your bookmarks backups will be stored." : "Adja meg egy mappa elérési útját a Fájlokban, ahol a könyvjelzők biztonsági másolatát tárolná.",

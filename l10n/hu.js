OC.L10N.register(
    ...
    "Unsupported file type for import: " : "Ismeretlen fájltípus az importáláshoz: ",
    ...
    "Collect and manage bookmarks, synced with all your devices" : "Könyvjelzők gyűjtése és kezelése, szinkronizálva az összes eszközével",
    "- 📂 Sort bookmarks into folders\n- 🏷 Add tags and personal notes\n- ☠ Find broken links and duplicates\n- 📲 Synchronize with all your browsers and devices\n- 📔 Store archived versions of your links in case they are depublished\n- 🔍 Full-text search on site contents\n- 👪 Share bookmarks with other users, groups and teams or via public links\n- ⚛ Generate RSS feeds of your collections\n- 📈 Stats on how often you access which links\n- 🔒 Automatic backups of your bookmarks collection\n- 💼 Built-in Dashboard widgets for frequent and recent links\n\nRequirements:\n - PHP extensions:\n   - intl: *\n   - mbstring: *\n - when using MySQL, use at least v8.0" : "- 📂 Könyvjelzők mappákba rendezése\n- 🏷 Címkék és személyes jegyzetek hozzáadása\n- ☠ Hibás hivatkozások és duplikátumok kiszűrése\n- 📲 Szinkronizálás az összes böngészővel és eszközzel\n- 📔 Hivatkozások archivált verzióinak tárolása, arra az esetre, ha leveszik az eredetit\n- 🔍 Teljes szöveges keresés az oldalak tartalmában\n- 👪 Könyvjelzők megosztása más felhasználókkal, csoportokkal vagy csapatokkal, vagy nyilvános hivatkozással\n- ⚛ RSS-hírforrások előállítása a gyűjteményekből\n- 📈 Statisztikák a hivatkozások eléréseiről\n- 🔒 Automatikus mentés a teljes gyűjteményről\n- 💼 Beépített Irányítópult modulok a gyakori és friss hivatkozásokkal\n\nKövetelmények:\n- PHP bővítmények:\n  - intl: *\n  - mbstring: *\n- MySQL esetén legalább v8.0",
    ...
    "You have never clicked this link" : "Még soha nem kattintott erre a hivatkozásra",
    "You have clicked this link {count} times" : "{count} alkalommal kattintott erre a hivatkozásra",
    "Details" : "Részletek",
    "Rename" : "Átnevezés",
    ...
    "Restore bookmark" : "Könyvjelző helyreállítása",
    ...
    "Searching in the current folder only." : "Keresés csak a jelenlegi mappában.",
    ...
    "_Selected %n folder_::_Selected %n folders_" : ["%n mappa kiválasztva","%n mappa kiválasztva"],
    ...
    "Do you really want to permanently delete this folder?" : "Biztos, hogy végleg törli ezt a mappát?",
    ...
    "Restore folder" : "Mappa helyreállítása",
    ...
    "Loading trashbin" : "Kuka betöltése",
    "Restoring folder" : "Mappa helyreállítása",
    ...
    "Recent" : "Friss",
    "Frequently clicked" : "Gyakran rákattintva",
    ...
    "Bookmarks Settings" : "Könyvjelzőbeállítások",
    ...
    "Your search yielded no results in the current folder." : "Nincs találat a jelenlegi mappában.",
    ...
    "You haven't deleted anything yet." : "Még nem törölt semmit.",
    ...
    "The bookmarks app can automatically archive the web content of links you have bookmarked" : "A Könyvjelzők alkalmazás képes automatikusan archiválni a mentett hivatkozások tartalmát",
    ...
    "Currently your administrator has disabled network access for this app, however, which is why Auto-archiving is disabled at the moment." : "Jelenleg a Könyvjelzők alkalmazás internetelérését letiltotta a rendszergazda, ezért most nem lehet automatikusan archiválni a hivatkozások tartalmát.",
    "Auto-Backup" : "Automatikus biztonsági mentés",
    "The bookmarks app can automatically backup your bookmarks on a daily basis to prevent data loss when syncing bookmarks across devices." : "A Könyvjelzők alkalmazás képes naponta automatikus mentést készíteni a könyvjelző-gyűjteményről az adatvesztés megelőzése érdekében, ha esetleg a szinkronizálásnál valami hiba lép fel.",
    ...
    "Context Chat integration" : "Context Chat integráció",
    "The bookmarks app can automatically make available the textual contents of the websites you bookmark to Context Chat, which allows asking questions about and getting answers based on those contents. This is only available if auto-archiving is enabled." : "A Könyvjelzők alkalmazás automatikusan elérhetővé tudja tenni a weboldalak szöveges tartamát a Környezeti csevegésben, így kérdéseket tehet fel és válaszokat kaphat a tartalom alapján. Ez csak akkor érhető el, ha az automatikus archiválás be van kapcsolva.",
    "Context chat is currently not installed, but is required for this feature." : "A Környezeti csevegés jelenleg nincs telepítve, de szükséges ehhez a funkcióhoz.",
    "Enable Context Chat integration" : "Környezeti csevegés integrációjának bekapcsolása",
    ...
    "Install web app" : "Webalkalmazás telepítése",
    ...
    "If you have problems with this Bookmarks app or have an idea about what could be improved, don't hesitate to get in touch by clicking here." : "Ha valami problémája van a Könyvjelzők alkalmazással, vagy van egy ötlete, javaslata, ne habozzon kapcsolatba lépni velünk ezen a hivatkozáson.",
    "Support this project" : "Projekt támogatása",
    "My work on this Bookmarks app is fuelled by a voluntary subscription model. If you think what I do is worthwhile, I would be happy if you could support my work. Also, please consider giving the app a review on the Nextcloud app store. Thank you 💙 " : "A Könyvjelzők alkalmazásba tett munkámat támogathatja egy önkéntes előfizetéssel. Amennyiben értékeli ezt a munkát, örülnék, ha megtenné. Plusz esetleg értékelje az alkalmazást a Nextcloud alkalmazástárában. Köszönöm! 💙 ",
    ...
    "Resharing allowed" : "A továbbosztás engedélyezett",
    ...
    "Would you like to support this project?" : "Szeretné támogatni ezt a projektet?",
    "Leave a rating on the Nextcloud App Store" : "Adjon le értékelést a Nextcloud alkalmazástárban",
    "Failed to save settings" : "A beállítások mentése sikertelen",
    "Failed to load settings" : "A beállítások betöltése sikertelen",
    "Privacy" : "Adatvédelem",
    "The app will try to access web pages that you add to automatically add information about them." : "Az alkalmazás megpróbálja letölteni a hozzáadott weboldalakat, hogy automatikusan további információkkal egészítse ki őket.",
    ...
    "Previews" : "Előnézetek",
    "In order to display real screenshots of your bookmarked websites, the app can use third-party services to generate previews." : "Hogy valódi képernyőképeket lehessen megjeleníteni a könyvjelzőzött weboldalakhoz, az alkalmazás külső szolgáltatást tud igénybe venni az előnézetek előállításához.",
    "Screeenly" : "Screeenly",
    ...
    "Screeenly API URL" : "Screeenly API webcíme",
    "Screeenly API key" : "Screeenly API-kulcs",
    "ScreenshotMachine" : "ScreenshotMachine",
    "ScreenshotMachine API key" : "ScreenshotMachine API-kulcs",
    "Webshot" : "Webshot",
    "Webshot API URL" : "Webshot API webcíme",
    "Generic screenshot API" : "Általános képernyőkép API",
    "Sign up with any of the screenshot API providers and put the API URL below. Use the variable {url} as a placeholder for the URL to screenshot. The API must return only the image directly." : "Regisztráljon valamelyik képernyőkép API szolgáltatónál, és adja meg alább az API webcímét. A webcímben a lefotózandó oldal címét az {url} változóval adhatja meg. Az API-nak közvetlenül a képernyőképet kell visszaadnia a válaszban.",
    "Generic API URL" : "Általános API webcíme",
    "Pageres CLI" : "Pageres CLI",
    "Simply install the Pageres CLI by Sindre Sorhus on your server and Bookmarks will find it. You can still add additional ENV vars to be fed to pageres, e.g. as indicated in the placeholder:" : "Csak telepítse a Pageres CLI-t (Sindre Sorhus programja) a kiszolgálóra, és a Könyvjelzők meg fogja találni. További környezeti változókat is adhat meg a pageresnek, például ahogy a helykitöltő mutatja:",
    "Pageres ENV variables" : "Pageres környezeti változók",
    "This URL is already bookmarked! Overwrite?" : "Ez a webcím már könyvjelzőzve van. Felülírja?",
    "Bookmark saved!" : "Könyvjelző mentve.",
    "Enter bookmark title" : "Adja meg a könyvjelző címét",
    "Enter bookmark URL" : "Adja meg a könyvjelző webcímét",
    "Folder" : "Mappa",
    "Root Folder" : "Gyökérmappa",
    "Save" : "Mentés",
    ...
    "Failed to count deleted bookmarks" : "Nem sikerült megszámolni a törölt könyvjelzőket",
    "Failed to count duplicated bookmarks" : "Az ismételt könyvjelzők megszámolása sikertelen",
    "Failed to count bookmarks" : "Nem sikerült megszámolni a könyvjelzőket",
    ...
    "Failed to restore bookmark" : "Nem sikerült helyreállítani a könyvjelzőket",
    ...
    "Failed to restore folder" : "Nem sikerült helyreállítani a mappát",
    "Failed to create folder" : "A mappa létrehozása sikertelen",
    "Failed to load children order" : "Nem sikerült betölteni a gyermekek sorrendjét",
    "Failed to move parts of selection" : "Kiválasztás részeinek áthelyezése sikertelen",
    "Failed to copy parts of selection" : "Nem sikerült másolni a kijelölés egy részét",
    "Failed to delete parts of selection" : "Kiválasztás részeinek törlése sikertelen",
    "Failed to tag parts of selection" : "Nem sikerült címkézni a kijelölés egy részét",
    "Failed to fetch bookmarks." : "A könyvjelzők lekérése sikertelen.",
    "Failed to store setting" : "Nem sikerült tárolni a beállítást",
    "Failed to load setting {key}" : "A(z) {key} beállítás betöltése sikertelen",
    "Failed to create share for folder {folderId}" : "Nem sikerült megosztást létrehozni a(z) {folderId} mappához",
    ...
    "Failed to create public link for folder {folderId}" : "Nem sikerült nyilvános hivatkozást létrehozni a(z) {folderId} mappához",
    "Failed to delete public link for folder {folderId}" : "Nem sikerült törölni a(z) {folderId} mappa nyilvános hivatkozását",
    "Failed to permanently delete parts of trash bin" : "Nem sikerült a kuka részeinek végleges törlése",

OC.L10N.register(
    ...
    "This app provides you with a web interface for collecting, organizing and sharing bookmarks to the sites on the web that are precious to you.\nYou can browse and filter your bookmarks via tags, folders and by using the built-in search feature and you can share folders with other users and groups as well as create public links for them.\nAlso, in order to access your bookmarks anywhere, it also allows you to synchronize with third-party clients via a built-in REST API -- be it in your browsers or on your phone.\nCheck out the third-party clients listed here: https://github.com/nextcloud/bookmarks#third-party-clients\n\nRequirements:\n - PHP v7.3+\n - PHP extensions:\n   - intl: *\n   - mbstring: *\n - Nextcloud v20+" : "Ez az alkalmazás webes kezelőfelületet biztosít az Ön számára értékes webhelyek könyvjelzőinek gyűjtéséhez, rendszerezéséhez és megosztásához.\nBöngészheti és szűrheti könyvjelzőit címkék és mappák szerint, illetve a beépített keresési funkció használatával, továbbá megoszthatja a mappákat más felhasználókkal és csoportokkal, valamint nyilvános hivatkozásokat hozhat létre hozzájuk.\nEzenkívül, hogy bárhol elérje a könyvjelzőket, lehetővé teszi a szinkronizálást harmadik felektől származó kliensekkel, a beépített REST API segítségével – legyen az a böngészőjében, vagy a telefonján.\nNézze meg az itt felsorolt külső klienseket: https://github.com/nextcloud/bookmarks#third-party-clients\n\nKövetelmények:\n- PHP v7.3+\n- PHP-bővítmények:\n  - intl: *\n  - mbstring: *\n- Nextcloud v20+",

OC.L10N.register(
    ...
    "Please select \"Add to home screen\" in your browser menu" : "お使いのブラウザで「ホーム画面に追加」ご選択ください",
    "Title" : "タイトル",
    "Link" : "リンク",
    "Creation date" : "作成日",
    "Tags" : "タグ",
    ...
    "Previews" : "プレビュー",
    "In order to display real screenshots of your bookmarked websites, Bookmarks can use third-party services to generate previews." : "ブックマークしたサイトの実際なスクリーンショットを表示する為、「ブックマーク」はサードパーティーのサービスを使用してサムネイルを生成可能です。",
    "Screeenly" : "Screeenly",

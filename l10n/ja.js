OC.L10N.register(
    ...
    "Someone bookmarked \"%s\"" : "どなたか「%s」をブックマークしました",
    "You deleted \"%s\"" : "「%s」を削除しました",
    "%1$s deleted \"%2$s\"" : "%1$sさんは「%2$s」を削除しました",
    "Someone deleted \"%s\"" : "どなたか「%s」を削除しました",
    "You created folder \"%s\"" : "フォルダー「%s」を作成しました",
    "%1$s created folder \"%2$s\"" : "%1$sさんはフォルダー「%2$s」を作成しました",
    "Someone created folder \"%s\"" : "どなたかフォルダー「%s」を作成しました",
    "You moved folder \"%s\"" : "「%s」を移動しました",
    "%1$s moved folder \"%2$s\"" : "%1$sさんはフォルダー「%2$s」を移動しました",
    "Someone moved folder \"%s\"" : "どなたかフォルダー「%s」を移動しました",
    "You deleted folder \"%s\"" : "フォルダー「%s」を削除しました",
    "%1$s deleted folder \"%2$s\"" : "%1$sさんはフォルダー「%2$s」を削除しました",
    "Someone deleted folder \"%s\"" : "どなたかフォルダー「%s」を削除しました",
    "You shared folder \"%1$s\" with %2$s" : "あなたはフォルダー「%1$s」を%2$sさんと共有しました",
    "You shared folder \"%s\" with someone" : "あなたはフォルダー「%s」をどなたかと共有しました",
    "%1$s shared folder \"%2$s\" with you" : "%1$sさんはフォルダー「%2$s」をあなたと共有しました",
    "Someone shared folder \"%s\" with you" : "どなたかフォルダー「%s」をあなたと共有しました",
    "You unshared folder \"%1$s\" with %2$s" : "あなたはフォルダー「%1$s」を%2$sさんとの共有を解除しました",
    "You unshared folder \"%s\" with someone" : "あなたはフォルダー「%s」をどなたかとの共有を解除しました",
    "%1$s unshared folder \"%2$s\" with you" : "%1$sさんはフォルダー「%2$s」をあなたとの共有を解除しました",
    "Someone unshared folder \"%s\" with you" : "どなたかフォルダー「%s」をあなたとの共有を解除しました",
    ...
    "Grid view" : "グリッド表示",
    "List view" : "リスト表示",
    "RSS Feed of current view" : "今のビューのRSSフィード",
    ...
    "No archived bookmarks" : "アーカイブ済みのブックマークがありません",
    "Bookmarks to files like photos or PDFs will automatically be saved to your Nextcloud files, so you can still find them even when the link goes offline." : "ファイルへのブックマーク、例えば画像もしくはPDFは自動的あなたのNextcloudファイルに保存ので、リンクがオフラインになっても見つかれます。",
    "No bookmarks here" : "ブックマークがありません",
    "Start by importing bookmarks from a file or synchronizing your browser bookmarks with this app" : "ブックマークをファイルからインポートが、このアプリであなたのブラウザーブックマークと同期して始めましょう",
    ...
    "Clear data" : "データを消去",
    "Permanently remove all bookmarks from your account." : "すべてのブックマークを永久にあなたのアカウントから削除します。",
    "Delete all bookmarks" : "すべてのブックマークを削除",
    "Do you really want to delete all your bookmarks?" : "本当にすべてのブックマークを削除しますか？",
    "Please select \"Add to home screen\" in your browser menu" : "お使いのブラウザで「ホーム画面に追加」をご選択ください",
    "Title" : "タイトル",
    "Link" : "リンク",
    "Creation date" : "作成日",
    "Tags" : "タグ",
    ...
    "Attachments" : "添付ファイル",
    "Archived version" : "アーカイブ済みのバージョン",
    "Open archived file" : "アーカイブ済みのファイルを開く",
    "Notes" : "メモ",
    ...
    "Performance" : "パフォーマンス",
    "In an installation with a lot of users it may be useful to restrict the number of bookmarks per account." : "大量なユーザーのいるインスタンスで、ブックマーク数をアカウント毎に制限は役を立つかも知れません。",
    ...
    "Previews" : "プレビュー",
    "In order to display real screenshots of your bookmarked websites, Bookmarks can use third-party services to generate previews." : "ブックマークしたサイトの実際なスクリーンショットを表示するために、「ブックマーク」はサードパーティーのサービスを使用してサムネイルを生成できます。",
    "Screeenly" : "Screeenly",
    ...
    "Simply install the pageres cli on your server and bookmarks will find it." : "あなたのサーバーでpageres cliをインストールすれば、「ブックマーク」はpageres cliを見つかれます。",

OC.L10N.register(
    ...
    "You created folder \"%s\"" : "Du hast das Verzeichnis \"%s\" erstellt",
    ...
    "You moved folder \"%s\"" : "Du hast das Verzeichnis \"%s\" verschoben",
    ...
    "You deleted folder \"%s\"" : "Du hast das Verzeichnis \"%s\" gelöscht",
    ...
    "You shared folder \"%1$s\" with %2$s" : "Du hast das Verzeichnis \"%1$s\" mit %2$s geteilt",
    "You shared folder \"%s\" with someone" : "Du hast das Verzeichnis \"%s\" mit jemanden geteilt",
    "%1$s shared folder \"%2$s\" with you" : "%1$s hat das Verzeichnis \"%2$s mit Dir geteilt",
    "Someone shared folder \"%s\" with you" : "Jemand hat das Verzeichnis \"%s\" mit Dir geteilt",
    "You unshared folder \"%1$s\" with %2$s" : "Du hast die Freigabe des Verzeichnisses \"%1$s\" für %2$s aufgehoben",
    "You unshared folder \"%s\" with someone" : "Du hast die Freigabe des Verzeichnisses \"%s\" für jemanden aufgehoben",
    ...
    "RSS Feed" : "RSS-Feed",
    "This is an RSS feed of the current result set with access restricted to you." : "Dies ist ein RSS-Feed der aktuellen Ergebnisse, auf den nur Du Zugriff hast.",

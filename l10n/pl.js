OC.L10N.register(
    ...
    "%1$s deleted \"%1$s\"" : "%1$s usunął \"%1$s\"",
    ...
    "You unshared folder \"%1$s\" with %2$s" : "Cofnąłeś udostępnianie katalogu \"%1$s\" dla %2$s",
    "You unshared folder \"%s\" with someone" : "Cofnąłeś komuś udostępnianie katalogu \"%s\"",
    "%1$s unshared folder \"%2$s\" with you" : "%1$s cofnął Tobie udostępnianie katalogu \"%2$s\"",
    "Someone unshared folder \"%s\" with you" : "Ktoś cofnął Tobie udostępnianie katalogu \"%s\"",
    ...
    "Select all visible" : "Wybierz wszystkie widoczne",
    ...
    "Shared privately" : "Udostępnione prywatnie",
    "Public" : "Publiczne",
    ...
    "Allow sharing" : "Pozwolenie na udostępnianie",
    ...
    "Failed to load setting {key}" : "Ustawienia nie zostały wczytane {key}",

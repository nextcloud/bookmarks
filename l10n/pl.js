OC.L10N.register(
    ...
    {
    "Bookmarks" : "Zakładki",
    "Not allowed to access folder to import into" : "Nie można uzyskać dostępu do folderu, aby go zaimportować",
    ...
    "This app provides you with a web interface for collecting and organizing bookmarks to the sites on the web that are precious to you. You can browse and filter your bookmarks via tags and folders and by using the built-in search feature. Furthermore, in order to access your bookmarks anywhere, it also allows you to synchronize third-party clients via a built-in REST API -- in your browsers and on your phone.\n\nCheck out the third-party clients listed here: https://github.com/nextcloud/bookmarks#third-party-clients" : "Ta aplikacja zapewnia poprzez interfejs sieciowy do zbierania i organizowania zakładek dla stron internetowych, które są dla Ciebie ważne. Możesz przeglądać i filtrować zakładki według etykiet i folderów oraz za pomocą wbudowanej funkcji wyszukiwania. Uzyskanie dostępu do zakładek z dowolnego miejsca, jest możliwe poprzez synchronizację klientów innych firm za pośrednictwem wbudowanego interfejsu API REST - w przeglądarkach i telefonie.\n\nSprawdź listę klientów zewnętrznych: https://github.com/nextcloud/bookmarks#third-party-clients",

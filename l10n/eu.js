OC.L10N.register(
    ...
    "Takes a link and adds it to your collection of bookmarks." : "Esteka bat hartu eta laster-marken bildumara gehitzen du.",
    "Bookmarks Backups" : "Laster-markak babeskopiak",
    "Collect and manage bookmarks, synced with all your devices" : "Gorde eta kudeatu laster-markak, zure gailu guztietan sinkronizaturik",
    "- 📂 Sort bookmarks into folders\n- 🏷 Add tags and personal notes\n- ☠ Find broken links and duplicates\n- 📲 Synchronize with all your browsers and devices\n- 📔 Store archived versions of your links in case they are depublished\n- 🔍 Full-text search on site contents\n- 👪 Share bookmarks with other users, groups and teams or via public links\n- ⚛ Generate RSS feeds of your collections\n- 📈 Stats on how often you access which links\n- 🔒 Automatic backups of your bookmarks collection\n- 💼 Built-in Dashboard widgets for frequent and recent links\n\nRequirements:\n - PHP extensions:\n   - intl: *\n   - mbstring: *\n - when using MySQL, use at least v8.0" : "- 📂 Ordenatu laster-markak karpetetan\n- 🏷 Gehitu etiketak eta ohar pertsonalak\n- ☠ Aurkitu hautsitako estekak eta bikoiztuak\n- 📲 Zure arakatzaile eta gailu guztiekin sinkronizatu\n- 📔 Zure esteken artxibatutako bertsioak gordetzen ditu\n- 🔍 Testu osoko bilaketa gunearen edukietan\n- 👪 Partekatu laster-markak beste erabiltzaileekin, taldeekin edo esteka publikoen bidez\n- ⚛ Zure bildumako RSS iturriak sortu\n- 📈 Maiz sartzen zaren esteken estatistikek \n- 🔒 Zure laster-marken bildumaren babeskopia automatikoak\n- 💼 Ohiko esteketarako eta lotura berrietarako aginte-mahaiaren trepetak\n\nBaldintzak:\n- PHP luzapenak:\n- intl: *\n- mbstring: *\n- MySQL erabiltzen duzunean, erabili gutxienez v8.0",
    ...
    "You have never clicked this link" : "Ez duzu inoiz esteka hau sakatu",
    "You have clicked this link {count} times" : "Esteka hau {count}sakatu izan duzu ",
    "Details" : "Xehetasunak",
    "Rename" : "Berrizendatu",
    "Copy link" : "Kopiatu esteka",
    "Move" : "Mugitu",
    "Add to folders" : "Gehitu karpetetara",
    "Put bookmark into trash bin" : "Jarri laster-marka zakarrontzian",
    "Restore bookmark" : "Berrezarri laster-marka",
    "Delete bookmark permanently" : "Ezabatu laster-marka betiko",
    ...
    "These are your deleted items. Items will be deleted permanently after two months." : "Hauek zure ezabaturiko elementuak dira. Bi hilabeteren ondoren betirako ezabatzen dira.",
    ...
    "Open folder details" : "Ireki karpetaren xehetasunak",
    ...
    "Do you really want to permanently delete this folder?" : "Ziur zaude karpeta hau betiko ezabatu nahi duzula?",
    ...
    "Put folder into trashbin" : "Jarri karpeta zakarrontzian",
    "Restore folder" : "Berrezarri karpeta",
    "Delete folder permanently" : "Ezabatu karpeta betirako",
    ...
    "Emptying trashbin" : "Zakarrontzia husten",
    ...
    "No deleted bookmarks" : "Ez dago ezabatutako laster-markarik",
    "You haven't deleted anything yet." : "Oraindik ez duzu ezer ezabatu.",
    ...
    "Currently your administrator has disabled network access for this app, however, which is why Auto-archiving is disabled at the moment." : "Une honetan zure administratzaileak aplikazio honen sarerako sarbidea desgaitu du, horregatik artxibo automatikoa desgaituta dago momentu honetan.",
    ...
    "If you have problems with this Bookmarks app or have an idea about what could be improved, don't hesitate to get in touch by clicking here." : "Bookmarks aplikazio honekin arazoak badituzu edo hobetu daitekeenari buruzko ideiarik baduzu, ez izan zalantzarik eta jarri harremanetan hemen klik eginez.",
    "Support this project" : "Proiektu hau babestu",
    "My work on this Bookmarks app is fuelled by a voluntary subscription model. If you think what I do is worthwhile, I would be happy if you could support my work. Also, please consider giving the app a review on the Nextcloud app store. Thank you 💙 " : "Bookmarks aplikazio honetan nire lana borondatezko harpidetza-eredu batek elikatzen du. Egiten dudanak merezi duela uste baduzu, pozik egongo nintzateke nire lana babestuko bazenu. Horretaz gain, saiatu aplikazioari berrikuspena ematea Nextcloud aplikazio dendan. Eskerrik asko 💙",
    ...
    "The app will try to access web pages that you add to automatically add information about them." : "Zuk gehitzen dituzun web orriak atzitzen saiatuko da aplikazioa, automatikoki beraiei buruzko informazioa gehitzeko.",
    ...
    "In order to display real screenshots of your bookmarked websites, the app can use third-party services to generate previews." : "Zuk gordetako web orrien pantaila-argazkiak erakusteko, aplikazioak hirugarrenen zerbitzuak erabil ditzake aurrebista sortzeko.",
    "Screeenly" : "Screeenly",
    ...
    "Webshot" : "Webshot",
    "Webshot API URL" : "Webshot APIaren URLa",
    "Generic screenshot API" : "Pantaila-argazkiaren API orokorra",
    "Sign up with any of the screenshot API providers and put the API URL below. Use the variable {url} as a placeholder for the URL to screenshot. The API must return only the image directly." : "Eman izena pantaila-argazkiarako API-hornitzaileren batekin eta jarri behean APIaren URLa. Erabili  {url} aldagaia pantaila-argazkiaren URLrako leku-marka gisa. APIak irudia bakarrik itzuli behar du zuzenean.",
    "Generic API URL" : "APIaren URL generikoa",
    "Pageres CLI" : "Pageres CLI",
    "Simply install the Pageres CLI by Sindre Sorhus on your server and Bookmarks will find it. You can still add additional ENV vars to be fed to pageres, e.g. as indicated in the placeholder:" : "Instalatu Sindre Sorhus-en Pageres CLI zure zerbitzarian eta Laster-markak-ek aurkituko du. Oraindik ENV aldarazte gehigarriak gehi ditzakezu orrialdeetara elikatzeko, adibidez. leku-markak adierazten duen moduan:",
    ...
    "Leave a rating on the Nextcloud App Store" : "Eman balorazio bat Nextcloud Aplikazioen Biltegian",
    "What" : "Zer",
    ...
    "Failed to load deleted folders" : "Ezabaturiko karpetak kargatzeak huts egin du",
    "Failed to load deleted bookmarks" : "Ezabatutako laster-markak kargatzeak huts egin du",
    "Failed to delete folder" : "Karpeta ezabatzeak huts egin du",
    "Failed to move folder" : "Karpeta mugitzeak huts egin du",

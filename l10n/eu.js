OC.L10N.register(
    ...
    "- 📂 Browse and filter your bookmarks via tags and folders and add personal notes\n- 🔍 Built-in full-text search integrated into Nextcloud's unified search\n- 👪 Share bookmarks with other users as well as publicly\n- 💡 Keep track of changes in the activity stream\n- ☠ Easily find broken links\n- 📔 All your links are automatically archived for full-text search and in case they are depublished\n- 📲 Access your bookmarks anywhere, on desktop Browsers and on your phone, via a variety of sync clients\n- 💼 Built-in Dashboard widgets for frequent and recent links\n- ⚛ Easily generate public and private RSS feeds of your collections\n\nRequirements:\n - PHP v7.3+\n - PHP extensions:\n   - intl: *\n   - mbstring: *\n - Nextcloud v20+" : "- 📂 Arakatu eta iragazi zure laster-markak etiketa eta karpeten bidez eta gehitu nota pertsonalak\n- 🔍 Testu osoko bilaketa integratua Nextcloud-en bilaketa bateratuan\n- 👪 Partekatu laster-markak beste erabiltzaileekin edo publikoki\n- 💡 Jarraitu aldaketak jarduera jarioaren bidez\n- ☠ Aurkitu apurtutako estekak modu errazean\n- 📔 Zure estekak automatikoki artxibatzen dira testu osoko bilaketan publikotik kentzen bada\n- 📲 Ikusi zure laster-markak edonondik, mahaigaineko nabigatzailetan eta zure telefonoan, hainbat sinkronizazio bezeroen bidez\n- 💼 Paneleko trepeta integratuak maiz erabilitako eta azken estekak\n- ⚛ Sortu RSS jario publiko eta pribatuak zure kolekzioentzako modu errazean\n\nEskakizunak:\n - PHP v7.3+\n - PHP hedapenak:\n   - intl: *\n   - mbstring: *\n - Nextcloud v20+",
    ...
    "This app allows you to manage links to your favorite places on the web." : "Aplikazio honek sareko gogoko tokietarako estekak kudeatzeko aukera ematen dizu.",
    "Sort your bookmarks into folders, label them with tags and share them with others! The app will regularly check all your links for availability and display unavailable links. If you add a link to a file on the web, the file will be automatically downloaded to your Nextcloud Files. You can also import bookmarks exported from other services or directly sync bookmarks from all your browsers with this app." : "Ordenatu zure laster-markak karpetetan, etiketatu eta partekatu besteekin! Aplikazioak aldian-aldian zure esteka guztiak egiaztatuko ditu eta erabilgarri ez dauden estekak bistaratuko ditu. Webeko fitxategi bati esteka gehitzen baduzu, fitxategia automatikoki deskargatuko da zure Nextcloud Fitxategietara. Beste zerbitzu batzuetatik esportatutako laster-markak ere inporta ditzakezu edo zuzenean arakatzaile guztietako laster-markak sinkroniza ditzakezu aplikazio honekin.",

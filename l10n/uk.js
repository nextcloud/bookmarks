OC.L10N.register(
    ...
    "Failed to restore folder" : "Не вдалося відновити папку",
    ...
    "Failed to create public link for folder {folderId}" : "Не вдалося створити публічне посилання для папки {folderId}",
    "Failed to delete public link for folder {folderId}" : "Не вдалося видалити публічне посилання для папки {folderId}",

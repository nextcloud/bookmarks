OC.L10N.register(
    ...
    "Grid view" : "網格檢視",
    "List view" : "清單檢視",
    "RSS Feed of current view" : "當前視圖的RSS Feed",
    "Move selection" : "移動選擇",
    ...
    "Start by importing bookmarks from a file or synchronizing your browser bookmarks with this app" : "首先從檔案中導入書籤，或與此瀏覽器同步瀏覽器書籤",
    ...
    "Custom order" : "自訂順序",
    "Archive path" : "封存路徑",
    "Enter the path of a folder where bookmarked files should be stored" : "輸入應該存儲書籤檔案的資料夾的路徑",
    ...
    "Clear data" : "清除資料",
    "Permanently remove all bookmarks from your account." : "從您的帳戶中永久刪除所有書籤。",
    ...
    "Attachments" : "附件",
    "Archived version" : "已封存版本",
    "Open archived file" : "開啟已封存檔案",
    "Notes" : "筆記",
    ...
    "ScreenshotMachine API key" : "ScreenshotMachine API API 密鑰",
    "Pageres CLI" : "Pageres CLI",
    "Simply install the pageres cli on your server and bookmarks will find it." : "只需在您的伺服器上安裝 pageres cli，書籤就會找到它。",

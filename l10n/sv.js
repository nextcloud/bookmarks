OC.L10N.register(
    ...
    "This app provides you with a web interface for collecting, organizing and sharing bookmarks to the sites on the web that are precious to you.\nYou can browse and filter your bookmarks via tags, folders and by using the built-in search feature and you can share folders with other users and groups as well as create public links for them.\nAlso, in order to access your bookmarks anywhere, it also allows you to synchronize with third-party clients via a built-in REST API -- be it in your browsers or on your phone.\nCheck out the third-party clients listed here: https://github.com/nextcloud/bookmarks#third-party-clients\n\nRequirements:\n - PHP v7.2+\n - PHP extensions:\n   - intl: *\n   - mbstring: *\n - Nextcloud v17+" : "Denna app tillhandahåller ett webbgränssnitt för att samla in, organisera och dela bokmärken till de webbplatser på nätet som är värdefulla för dig.\nDu kan bläddra i och filtrera dina bokmärken via taggar, mappar och med hjälp av den inbyggda sökfunktionen och du kan dela mappar med andra användare och grupper samt skapa offentliga länkar till dem.\nFör att komma åt dina bokmärken var som helst låter det dig också synkronisera med tredjepartsklienter via ett inbyggt REST API - vare sig det är i din webbläsare eller på din telefon.\nKolla in de tredjeparts klienter som listas här: https://github.com/nextcloud/bookmarks#third-party-clients\n\nKrav:\n- PHP v7.2 +\n- PHP-tillägg:\n- intl: *\n- mbstring: *\n- Nextcloud v17 +",
    ...
    "No archived bookmarks" : "Inga arkiverade bokmärken",
    ...
    "Custom order" : "Anpassad sortering",
    ...
    "Attachments" : "Bilagor",
    "Archived version" : "Arkiverad version",
    "Open archived file" : "Öppna arkiverad fil",
    "Notes" : "Anteckning",
    "{time} ago" : "{time} sedan",
    "Owner" : "Ägare",
    "Sharing" : "Delning",

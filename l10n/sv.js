OC.L10N.register(
    ...
    "Restore bookmark" : "Återställ bokmärke",
    ...
    "This app allows you to manage links to your favorite places on the web. Sort your bookmarks into folders, label them with tags and share them with others! The app will regularly check all your links for availability and display unavailable links. If you add a link to a file on the web, the file will be automatically downloaded to your Nextcloud Files. You can also import bookmarks exported from other services or directly sync bookmarks from all your browsers with this app." : "Denna app låter dig hantera länkar till dina favoritplatser på webben. Sortera dina bokmärken i mappar, märk dem med taggar och dela dem med andra! Appen kontrollerar regelbundet alla dina länkar för tillgänglighet och visar otillgängliga länkar. Om du lägger till en länk till en fil på webben kommer filen automatiskt att laddas ner till dina Nextcloud-filer. Du kan också importera bokmärken som exporterats från andra tjänster eller direkt synkronisera bokmärken från alla dina webbläsare med denna app.",
    ...
    "Loading trashbin" : "Laddar papperskorg",
    ...
    "The bookmarks app can automatically make available the textual contents of the websites you bookmark to Context Chat, which allows asking questions about and getting answers based on those contents. This is only available if auto-archiving is enabled." : "Bokmärkesappen kan automatiskt göra det textuella innehållet på de webbplatser du bokmärker tillgängligt för Kontextchatt, vilket gör att du kan ställa frågor om och få svar baserade på det innehållet. Detta är endast tillgängligt om autoarkivering är aktiverad.",
    "Context chat is currently not installed, but is required for this feature." : "Kontextchatt är för närvarande inte installerad, men krävs för denna funktion.",
    ...
    "Leave a rating on the Nextcloud App Store" : "Lämna ett omdöme på Nextcloud App Store",
    "Failed to save settings" : "Kunde inte spara inställningarna",
    "Failed to load settings" : "Kunde inte läsa in inställningar",
    "Privacy" : "Integritet",
    "The app will try to access web pages that you add to automatically add information about them." : "Appen kommer försöka komma åt webbsidor som du lägger till för att automatiskt lägga till information om dem.",
    ...
    "Generic screenshot API" : "Generisk skärmdump API",
    "Sign up with any of the screenshot API providers and put the API URL below. Use the variable {url} as a placeholder for the URL to screenshot. The API must return only the image directly." : "Registrera dig hos någon av API-leverantörerna för skärmdumpar och ange API-URL nedan. Använd variabeln {url} som platshållare för webbadressen för skärmdump. API:t måste endast returnera bilden direkt.",
    ...
    "Failed to count deleted bookmarks" : "Kunde inte räkna borttagna bokmärken",
    "Failed to count duplicated bookmarks" : "Det gick inte att räkna dubblerade bokmärken",
    "Failed to count bookmarks" : "Kunde inte räkna bokmärken",
    ...
    "Failed to restore bookmark" : "Kunde inte återställa bokmärke",
    ...
    "Failed to load deleted folders" : "Kunde inte läsa in borttagna mappar",
    "Failed to load deleted bookmarks" : "Kunde inte läsa in borttagna bokmärken",
    "Failed to delete folder" : "Kunde inte radera mapp",
    "Failed to move folder" : "Det gick inte att flytta mappen",
    "Failed to restore folder" : "Kunde inte återställa mapp",
    "Failed to create folder" : "Kunde inte skapa mapp",
    "Failed to load children order" : "Kunde inte läsa in underordnade objekt",
    "Failed to move parts of selection" : "Kunde inte flytta vissa delar av urvalet",
    "Failed to copy parts of selection" : "Kunde inte kopiera delar av markeringen",
    "Failed to delete parts of selection" : "Kunde inte ta bort delar av urvalet",
    "Failed to tag parts of selection" : "Kunde inte tagga delar av markeringen",
    ...
    "Failed to create share for folder {folderId}" : "Kunde inte skapa delning för mappen {folderId}",
    ...
    "Failed to create public link for folder {folderId}" : "Kunde inte skapa offentlig länk för mappen {folderId}",
    "Failed to delete public link for folder {folderId}" : "Kunde inte ta bort offentlig länk för mappen {folderId}",
    "Failed to permanently delete parts of trash bin" : "Kunde inte permanent ta bort delar av papperskorgen",

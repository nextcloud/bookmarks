OC.L10N.register(
    ...
    "Try changing your query or add some using the button on the left." : "Försök ändra din fråga eller lägg till några med knappen till vänster.",
    ...
    "RSS Feed" : "RSS-flöde",
    "This is an RSS feed of the current result set with access restricted to you." : "Detta är ett RSS-flöde av det aktuella resultatet med åtkomst begränsad till dig.",
    ...
    "In an installation with  a lot of users it may be useful to restrict the number of bookmarks per account." : "I en installation med många användare kan det vara användbart att begränsa antalet bokmärken per konto.",

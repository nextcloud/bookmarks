OC.L10N.register(
    ...
    "Collect and manage bookmarks, synced with all your devices" : "Kerää ja hallitse kirjanmerkkejä, synkronoituna kaikille laitteillesi",
    ...
    "You have never clicked this link" : "Et ole koskaan napsauttanut tätä linkkiä.",
    "You have clicked this link {count} times" : "Olet napsauttanut tätä linkkiä {count} kertaa",
    "Details" : "Tiedot",
    "Rename" : "Nimeä uudelleen",
    "Copy link" : "Kopioi linkki",
    "Move" : "Siirrä",
    "Add to folders" : "Lisää kansioihin",
    "Put bookmark into trash bin" : "Aseta kirjanmerkki roskakoriin",
    "Restore bookmark" : "Palauta kirjanmerkki",
    "Delete bookmark permanently" : "Poista kirjanmerkki pysyvästi",
    ...
    "These are your deleted items. Items will be deleted permanently after two months." : "Nämä ovat poistamasi kohteet. Ne poistetaan pysyvästi kahden kuukauden jälkeen.",
    ...
    "Open folder details" : "Avaa kansion yksityiskohdat",
    ...
    "Do you really want to permanently delete this folder?" : "Haluatko varmasti poistaa tämän kansion pysyvästi?",
    ...
    "Put folder into trashbin" : "Aseta kansio roskakoriin",
    "Restore folder" : "Palauta kansio",
    "Delete folder permanently" : "Poista kansio pysyvästi",
    ...
    "Emptying trashbin" : "Tyhjennetään roskakoria",
    ...
    "Your search yielded no results in the current folder." : "Hakusi ei palauttanut tuloksia tässä kansiossa.",
    ...
    "No deleted bookmarks" : "Ei poistettuja kirjanmerkkejä",
    "You haven't deleted anything yet." : "Et ole poistanut vielä mitään.",
    ...
    "Support this project" : "Tue tätä projektia",
    ...
    "Leave a rating on the Nextcloud App Store" : "Jätä arvostelu Nextcloud-sovelluskaupassa",
    "What" : "Mitä",
    ...
    "Failed to count deleted bookmarks" : "Poistettujen kirjanmerkkien määrän laskeminen epäonnistui",
    "Failed to count duplicated bookmarks" : "Kaksoiskappaleiden laskenta epäonnistui",
    "Failed to count bookmarks" : "Kirjanmerkkien laskeminen epäonnistui",
    ...
    "Failed to restore bookmark" : "Kirjanmerkin palauttaminen epäonnistui",
    ...
    "Failed to load deleted folders" : "Poistettujen kansioiden lataaminen epäonnistui",
    "Failed to load deleted bookmarks" : "Poistettujen kirjanmerkkien lataaminen epäonnistui",
    "Failed to delete folder" : "Kansion poistaminen epäonnistui",
    "Failed to move folder" : "Kansion siirtäminen epäonnistui",
    "Failed to restore folder" : "Kansion palauttaminen epäonnistui",
    ...
    "Failed to create public link for folder {folderId}" : "Kansioon {folderId} johtavan julkisen linkin luominen epäonnistui",
    "Failed to delete public link for folder {folderId}" : "Kansioon {folderId} johtavan julkisen linkin poistaminen epäonnistui",

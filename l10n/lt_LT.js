OC.L10N.register(
    ...
    "This app provides you with a web interface for collecting and organizing bookmarks to the sites on the web that are precious to you.\nYou can browse and filter your bookmarks via tags and folders and by using the built-in search feature.\nAlso, in order to access your bookmarks anywhere, it also allows you to synchronize with third-party clients via a built-in REST API -- be it in your browsers or on your phone.\nCheck out the third-party clients listed here: https://github.com/nextcloud/bookmarks#third-party-clients\n\nRequirements:\n - PHP v7.1+\n - PHP extensions:\n   - gmp: *\n   - intl: *\n   - mbstring: *" : "Ši programėlė pateikia jums saityno sąsają, skirtą rinkti ir tvarkyti jums brangių internetinių svetainių adresyno įrašus.\nGalite naršyti ir filtruoti savo adresyno įrašus pagal žymes ir aplankus bei naudodami įtasytąją paieškos ypatybę.\nBe to, tam, kad gautumėte prieigą prie savo adresyno iš bet kurios vietos, programėlė, per įtaisytąjį REST API, taip pat leidžia jums sinchronizuoti su trečiųjų šalių klientų programomis -- nesvarbu, ar tai būtų jūsų naršyklėje, ar telefone.\nTrečiųjų šalių kliento programų sąrašą galite rasti čia: https://github.com/nextcloud/bookmarks#third-party-clients\n\nReikalavimai:\n - PHP v7.1+\n - PHP plėtiniai:\n   - gmp: *\n   - intl: *\n   - mbstring: *",
    ...
    "Performance" : "Našumas",
    "In an installation with  a lot of users it may be useful to restrict the number of bookmarks per account." : "Diegime su daugybe naudotojų gali būti naudinga apriboti kiekvienai paskyrai tenkantį adresyno įrašų skaičių.",
    ...
    "Failed to load setting " : "Nepavyko įkelti nustatymo",

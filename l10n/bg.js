OC.L10N.register(
    ...
    "This app allows you to manage links to your favorite places on the web." : "Това приложение ви позволява да управлявате връзки към любимите си места в мрежата.",
    "Sort your bookmarks into folders, label them with tags and share them with others! The app will regularly check all your links for availability and display unavailable links. If you add a link to a file on the web, the file will be automatically downloaded to your Nextcloud Files. You can also import bookmarks exported from other services or directly sync bookmarks from all your browsers with this app." : "Сортирайте вашите отметки в папки, маркирайте ги с тагове и ги споделете с други! Приложението редовно ще проверява всичките ви връзки за наличност и ще показва недостъпни връзки. Ако добавите връзка към файл в мрежата, файлът автоматично ще бъде изтеглен във вашите Nextcloud файлове. Можете също да импортирате отметки, експортирани от други услуги, или директно да синхронизирате отметки от всичките си браузъри с това приложение.",

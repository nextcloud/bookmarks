OC.L10N.register(
    ...
    "Start by importing bookmarks from a file or synchronizing your browser bookmarks with this app" : "Започнете с импортиране на отметки от файл или синхронизиране на отметките на вашия браузър с това приложение",

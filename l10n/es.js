OC.L10N.register(
    ...
    "This app allows you to manage links to your favorite places on the web. Sort your bookmarks into folders, label them with tags and share them with others! The app will regularly check all your links for availability and display unavailable links. If you add a link to a file on the web, the file will be automatically downloaded to your Nextcloud Files. You can also import bookmarks exported from other services or directly sync bookmarks from all your browsers with this app." : "Esta app te permite gestionar enlaces a tus lugares favoritos de la web. ¡Organiza tus marcadores en carpetas, etiqueta los mismos y compártelos con otros!. La app verificará periódicamente su disponibilidad y mostrará los que ya no son accesibles. Si añades un enlace a un archivo en la web, el mismo será automáticamente descargado a tus Archivos de Nextcloud. También puedes importar marcadores de otros servicios o sincronizar directamente tus marcadores del navegador con esta app.",
    ...
    "Simply install the Pageres CLI on your server and Bookmarks will find it. You can still add additional ENV vars to be fed to pageres, e.g. as indicated in the placeholder:" : "Simplemente instala el CLI de pageres en tu servidor y Bookmarks lo encontrará. Usted todavía puede agregar vars ENV adicionales para ser alimentados a pageres, por ejemplo, como se indica en el marcador de posición:",
    "Pageres ENV variables" : "Variables ENV de Pageres",

OC.L10N.register(
    ...
    "Performance" : "Απόδοση",
    "In an installation with  a lot of users it may be useful to restrict the number of bookmarks per account." : "Σε μια εγκατάσταση με πολλούς χρήστες μπορεί να είναι χρήσιμο να περιορίσετε τον αριθμό των σελιδοδεικτών ανά λογαριασμό.",

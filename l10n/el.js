OC.L10N.register(
    ...
    "%1$s deleted \"%2$s\"" : "%1$s διαγράφηκε \"%2$s\"",
    "Someone deleted \"%s\"" : "Κάποιος διαγράφηκε \"%s\"",
    "You created folder \"%s\"" : "Δημιουργήσατε τον φάκελο \"%s\"",
    "%1$s created folder \"%2$s\"" : "Ο %1$sδημιούργησε φάκελο \"%2$s\"",
    ...
    "%1$s shared folder \"%2$s\" with you" : "Ο %1$sδιαμοίρασε το φάκελο \"%2$s\" μαζί σας",

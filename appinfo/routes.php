...
return [
	'routes' => [
		...
		['name' => 'web_view#index', 'url' => '/trash', 'verb' => 'GET', 'postfix' => 'trash'],
		...
		['name' => 'internal_folders#restore_bookmark', 'url' => '/folder/{folderId}/bookmarks/{bookmarkId}/restore', 'verb' => 'POST'],
		...
		['name' => 'internal_folders#restore_folder', 'url' => '/folder/{folderId}/restore', 'verb' => 'POST'],
		...
		['name' => 'tags#rename_tag', 'url' => '/public/rest/v2/tag/{old_name}', 'verb' => 'POST'],
		['name' => 'tags#rename_tag', 'url' => '/public/rest/v2/tag/{old_name}', 'verb' => 'PUT'],
		['name' => 'tags#delete_tag', 'url' => '/public/rest/v2/tag/{old_name}', 'verb' => 'DELETE'],

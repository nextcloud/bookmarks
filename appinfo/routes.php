...
return [
	'routes' => [
		...
		['name' => 'internal_folders#delete_folder_permanently', 'url' => '/folder/permanent/{id}', 'verb' => 'DELETE'],
		['name' => 'internal_folders#restore_folder', 'url' => '/folder/restore/{id}', 'verb' => 'PUT'],

    ...
    <div class="bookmark_single" data-id="<&= id &>">
        <p class="bookmark_actions">
            <span class="bookmark_delete">
                <img class="svg" src="<?php print_unescaped(OCP\Template::image_path("", "actions/delete.svg")); ?>"
        ...
        <p class="bookmark_title">
            ...
            <span class="bookmark_edit bookmark_edit_btn">
                <img class="svg" src="<?php print_unescaped(OCP\Template::image_path("", "actions/rename.svg")); ?>" title="<?php p($l->t('Edit')); ?>">
            </span>
        </p>
...
<script type="text/html" id="tag_tmpl">
    <li><a href="" class="tag"><&= escapeHTML(tag) &></a>
        <div class="tags_actions">
            ...
            <span class="tag_edit">
                <img class="svg" src="<?php print_unescaped(OCP\Template::image_path("", "actions/rename.svg")); ?>"
